...
export class RegistrationPage {
    ...
    constructor(private alertCtrl: AlertController, public navCtrl: NavController, public navParams: NavParams, public formBuilder: FormBuilder,
        public remotService: RemoteServiceProvider, public zone: NgZone, public modalCtrl: ModalController, public events: Events, public regValidator: RegValidatorProvider, private fb: Facebook, private googlePlus: GooglePlus, private oneSignal: OneSignal, platform: Platform) {
