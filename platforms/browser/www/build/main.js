...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_aboutedit_aboutedit__ = __webpack_require__(259);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_categories_categories__ = __webpack_require__(63);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AboutmePage = (function () {
    function AboutmePage(navCtrl, alertCtrl, navParams, events, actionSheetCtrl, remotService, modalCtrl, http) {
        this.navCtrl = navCtrl;
        ...
        this.http = http;
        this.abouteditPage = __WEBPACK_IMPORTED_MODULE_4__pages_aboutedit_aboutedit__["a" /* AbouteditPage */];
        this.touserid = 0;
        this.languages = [];
        this.achievements = [];
        this.interests = [];
    ...
    AboutmePage.prototype.initviewaboutData = function () {
        ...
        this.remotService.postData(DataToSend, 'AboutmeDetails').subscribe(function (response) {
            _this.remotService.postData(DataToSend, 'getPrivacy').subscribe(function (responsePrivacy) {
                _this.editprivacyparams = responsePrivacy.data != null ? responsePrivacy.data : {};
    ...
    AboutmePage.prototype.ionViewDidEnter = function () {
        //console.log("Connection pages entered")
        this.content.resize();
    };
    AboutmePage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
    AboutmePage.prototype.editCreativeField = function (creativeFld) {
        var _this = this;
        var categoryModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_5__pages_categories_categories__["a" /* CategoriesPage */], { usertype: this.usertype });
    ...
    AboutmePage.prototype.removeLocation = function () {
        var _this = this;
        var paramsobj = {
            user_id: window.localStorage['userid'],
            token: window.localStorage['token']
        ...
        var alert = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    text: 'Remove',
                    handler: function () {
                        _this.remotService.presentLoading();
                        _this.remotService.postData(paramsobj, 'EditLocation').subscribe(function (response) {
                            _this.remotService.dismissLoader();
                            if (response.success == 1) {
    ...
    AboutmePage.prototype.editDatauser = function (edittype, editparam) {
        ...
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__pages_aboutedit_aboutedit__["a" /* AbouteditPage */], { 'editsection': edittype, 'editparam': editparam, "parentPage": this });
    };
    ...
    AboutmePage.prototype.updatePrivacy = function (edittype) {
        var _this = this;
        this.remotService.presentLoading();
        this.remotService.postData(this.paramsObj, "editAboutPrivacy").subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (response.success == 1) {
                if (_this.editprivacyparams.hasOwnProperty(edittype)) {
                    _this.editprivacyparams[edittype].value = _this.paramsObj['value'];
                }
            }
            else {
                _this.remotService.presentToast(response.message);
    ...
    AboutmePage.prototype.ionViewDidLoad = function () {
        ...
        this.navBar.backButtonClick = function () {
            if (_this.navParams.get('touserid')) {
...
AboutmePage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */], __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Http */]])
], AboutmePage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_social_sharing__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_photoview_photoview__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_photoupload_photoupload__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_image_picker__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_base64__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_photodetails_photodetails__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_camera__ = __webpack_require__(45);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AlbumviewPage = (function () {
    function AlbumviewPage(cameraservice, basesxfrservice, imagepick, alertCtrl, navCtrl, navParams, events, actionSheetCtrl, remotService, modalCtrl, socialSharing) {
    ...
    AlbumviewPage.prototype.initPhotoalbumData = function () {
        var _this = this;
        var DataToSend = {
            user_id: this.touserid,
    ...
    AlbumviewPage.prototype.ionViewWillEnter = function () {
        this.content.resize();
    };
    AlbumviewPage.prototype.ionViewDidLoad = function () {
        // console.log('ionViewDidLoad AlbumviewPage');
    };
    AlbumviewPage.prototype.gotoPhotoView = function (album, id) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__pages_photoview_photoview__["a" /* PhotoviewPage */], { "album": album, 'touserid': this.touserid, "img_id": id, "parentPage": this });
    };
        ...
        var actionSheet = this.actionSheetCtrl.create({
            buttons: [{
                ...
                },
                {
                    ...
                    handler: function () {
                        if (albm.ifAd == 1) {
                            _this.remotService.presentToast("You can't delete this album because you have advertised one image from this album");
                        }
                        else {
    ...
    AlbumviewPage.prototype.upLoadImages = function () {
        var _this = this;
        var actionSheet = this.actionSheetCtrl.create({
            title: "Add Image",
            buttons: [{
    ...
    AlbumviewPage.prototype.takePicture = function () {
        var _this = this;
        var options = {
            quality: 100,
    ...
    AlbumviewPage.prototype.saveImageToArrayBypath = function (item) {
        var _this = this;
        window.resolveLocalFileSystemURL(item, function (fileEntry) {
            fileEntry.getMetadata(function (metadata) {
                if (metadata.size > 20971520) {
                    _this.remotService.presentToast(' Please upload a file with size less than: ' + 20 + "MB");
                }
                else {
                    _this.basesxfrservice.encodeFile(item).then(function (base64File) {
                        ...
                        _this.albumParam = {
                            user_id: window.localStorage['userid'],
                            token: window.localStorage['token'],
                            privacy: _this.albumdetails.privacy,
                            album_name: _this.albumname,
                            description: _this.albumdescription,
                            image: JSON.stringify(photostosend),
                            Album_id: _this.album.id
                        };
                        _this.remotService.postData(_this.albumParam, url).subscribe(function (response) {
                            _this.remotService.dismissLoader();
                            if (response.success == 1) {
                                _this.remotService.dismissLoader();
                                _this.initPhotoalbumData();
    ...
    AlbumviewPage.prototype.getimage = function () {
        var _this = this;
        var options = {
    ...
    */
    AlbumviewPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
    AlbumviewPage.prototype.viewdetails = function (albumname, albumdescription) {
        var pagename = 'Album Details';
        var data = {
            image_title: albumname,
            image_description: albumdescription,
            pagename: pagename
        };
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_8__pages_photodetails_photodetails__["a" /* PhotodetailsPage */], { details: data });
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */])
], AlbumviewPage.prototype, "content", void 0);
__decorate([
...
AlbumviewPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-albumview',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\albumview\albumview.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title>{{albumname}}</ion-title>\n\n    <ion-buttons end>\n      <button *ngIf="touserid == currentuserid" (click)="editAlbum(album,$event);" class="edit" ion-button clear>\n        <ion-icon name="settings"></ion-icon>\n      </button>\n    </ion-buttons>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <ion-toolbar class="albumDes" (click)="viewdetails(albumname, albumdescription)">\n    <span *ngIf="albumname">\n      <b>Album Title : </b> {{albumname | slice:0:100}}\n      <span *ngIf="albumname.length>100">...</span>\n    </span>\n    <br>\n    <span *ngIf="albumdescription">\n      <b>Album Description : </b> {{albumdescription | slice:0:100}}\n      <span *ngIf="albumdescription.length>100">...</span>\n    </span>\n  </ion-toolbar>\n\n\n\n\n  <ion-row>\n    <ion-col col-6 *ngFor="let phto of albumphotos;" (click)="gotoPhotoView(album,phto.id);">\n      <div class="album_wrap">\n        <img img-preloader="{{base_url}}uploads/portfolioImages/resizedimages/{{phto.image_name}}" alt="Post Img" />\n      </div>\n    </ion-col>\n\n  </ion-row>\n\n\n\n\n  <ion-fab bottom right *ngIf="touserid == currentuserid">\n    <button ion-fab (click)="upLoadImages()" color="primary">\n      <i class="material-icons">add_a_photo</i>\n    </button>\n  </ion-fab>\n\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\albumview\albumview.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_9__ionic_native_camera__["a" /* Camera */], __WEBPACK_IMPORTED_MODULE_7__ionic_native_base64__["a" /* Base64 */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_image_picker__["a" /* ImagePicker */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PhotodetailsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
 ...
 * Ionic pages and navigation.
 */
var PhotodetailsPage = (function () {
    function PhotodetailsPage(events, navCtrl, navParams) {
        this.events = events;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    PhotodetailsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.events.publish('creoyou:hidemenu');
        this.navBar.backButtonClick = function () {
            _this.events.publish('creoyou:hidemenu');
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], PhotodetailsPage.prototype, "navBar", void 0);
PhotodetailsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-photodetails',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\photodetails\photodetails.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title *ngIf="details.pagename==\'\' || details.pagename==null">Image Details</ion-title>\n    <ion-title *ngIf="details.pagename">{{details.pagename}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-grid>\n    <ion-row>\n      <ion-col class="EventContainer">\n        <ion-list class="EventBody">\n          <ion-item>\n            <div class="EventDetails" *ngIf="details.image_title">\n              <b>Title : </b> {{details.image_title}}\n            </div>\n            <div class="EventDetails" *ngIf="details.image_description">\n              <b>Description : </b> {{details.image_description}}\n            </div>\n            <div class="EventDetails" *ngIf="details.image_keywords">\n              <b>Keywords : </b> {{details.image_keywords}}\n            </div>\n\n          </ion-item>\n        </ion-list>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\photodetails\photodetails.html"*/,
    }),
...
//# sourceMappingURL=photodetails.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_image_picker__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_crop__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_camera__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_base64__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_platform_browser__ = __webpack_require__(16);
...
var PhotouploadPage = (function () {
    ...
    PhotouploadPage.prototype.saveAlbum = function () {
        ...
        this.remotService.postData(this.albumParam, url).subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (response.success == 1) {
                _this.navParams.get("parentPage").initPhotoalbumData();
                _this.remotService.dismissLoader();
                _this.navCtrl.pop();
            }
            else {
    ...
    PhotouploadPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_otherprofile_otherprofile__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VideocommentPage = (function () {
    ...
    VideocommentPage.prototype.seecomment = function () {
        var _this = this;
        var commentsParams = {
            type: 'Video',
    ...
    VideocommentPage.prototype.OtherFrofileView = function (data) {
        if (data.user_status == 4) {
            ...
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__pages_otherprofile_otherprofile__["a" /* OtherprofilePage */], { 'otheruserfrofiledata': data });
        }
    };
...
var AudiocommentPage = (function () {
    ...
    AudiocommentPage.prototype.seecomment = function () {
        var _this = this;
        var commentsParams = {
            type: 'Audio',
    ...
    AudiocommentPage.prototype.OtherFrofileView = function (data) {
        if (data.user_status == 4) {
            this.remotService.presentToast('Your are not allowed to view that profile.');
        }
        else if (this.currentuserid == data.user_id) {
    ...
    AudiocommentPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_invitefriend_invitefriend__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_messagedetails_messagedetails__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_otherprofile_otherprofile__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ConnectionsPage = (function () {
    function ConnectionsPage(navCtrl, navParams, events, actionSheetCtrl, remotService, modalCtrl, alertCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.events = events;
        this.actionSheetCtrl = actionSheetCtrl;
    ...
    ConnectionsPage.prototype.ionViewDidEnter = function () {
        //console.log("Connection pages entered")
        this.content.resize();
    };
    ...
    ConnectionsPage.prototype.presentActionSheet = function (connection, index) {
        ...
        var actionSheet = this.actionSheetCtrl.create({
            ...
            \n\ </ul><p class='blkusr'>Unblock by going under Settings - Privacy</p>";
                        _this.removeConfirmationalert(DataToSend, 'blockUser', text, index);
                    }
                },
                {
                    text: 'Remove',
                    role: 'destructive',
                    handler: function () {
                        _this.removeConfirmationalert(DataToSend, 'unfriendUser', "Are you sure you want to remove this connection?", index);
                    }
                },
            ]
        });
    ...
    // remove firend 
    ConnectionsPage.prototype.removeConfirmationalert = function (DataToSend, url, messageText, index) {
        var _this = this;
        var alert = this.alertCtrl.create({
            title: 'Confirm',
            message: messageText,
            buttons: [
                {
                    ...
                    handler: function () {
                        _this.remotService.presentLoading();
                        _this.remotService.postData(DataToSend, url).subscribe(function (response) {
                            _this.remotService.dismissLoader();
                            if (response.success == 1) {
    ...
    ConnectionsPage.prototype.startMessage = function (connection, idx) {
        ...
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__pages_messagedetails_messagedetails__["a" /* MessagedetailsPage */], { user: connection, "parentPage": this });
    };
    /**
    ...
    */
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        _this.remotService.presentLoading();
                        _this.remotService.postData(DataToSend, 'deleteRequest').subscribe(function (response) {
                            _this.remotService.dismissLoader();
                            if (response.success == 1) {
                                _this.pendingusers.splice(index, 1);
                            }
    ...
    ConnectionsPage.prototype.sendFollowRequest = function (connection) {
        var _this = this;
    ...
    ConnectionsPage.prototype.EntermobilenoSendRequest = function (connection) {
        var _this = this;
        var alert = this.alertCtrl.create({
                ...
                },
                {
                    ...
                    handler: function (data) {
                        if (connection.mobile_no == data.mobileno) {
                            ...
                            _this.remotService.presentLoading();
                            _this.remotService.postData(DataToSend, 'sendRequset').subscribe(function (response) {
                                _this.remotService.dismissLoader();
                                if (response.success == 1) {
                                }
                                else {
                            ...
                            _this.remotService.presentToast('Mobile number is incorrect');
                        }
                    }
                }
            ]
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */])
], ConnectionsPage.prototype, "content", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_invitefriend_invitefriend__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_otherprofile_otherprofile__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FollowPage = (function () {
        ...
        this.remotService.postData(followerParams, 'followers').subscribe(function (response) {
            ...
            if (response.success == 1) {
                if (response.data != null) {
                    ...
                    _this.followermsg = 'No Followers';
                }
            }
            else {
                _this.followermsg = 'No Followers';
        ...
        this.remotService.postData(followingparams, 'following').subscribe(function (response) {
            ...
            if (response.success == 1) {
                if (response.data != null) {
                    ...
                    _this.followingmsg = 'Not following anyone';
                }
            }
            else {
                _this.followingmsg = 'Not following anyone';
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        ...
                        _this.remotService.presentToast(' You have unfollowed successfully');
                        _this.remotService.postData(unfollowerparams, 'unfollowUser').subscribe(function (response) {
                            // console.log(response);
                            if (response.success == 1) {
                                if (type == 1) {
    ...
    FollowPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
    return FollowPage;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */])
], FollowPage.prototype, "content", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_categories_categories__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_reg_validator_reg_validator__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_login_login__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_google_plus__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_facebook__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__socialreg_socialreg__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_changemobilenumber_changemobilenumber__ = __webpack_require__(267);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RegistrationPage = (function () {
    function RegistrationPage(alertCtrl, navCtrl, navParams, formBuilder, remotService, zone, modalCtrl, events, regValidator, fb, googlePlus) {
        this.alertCtrl = alertCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        ...
        this.FormRegistrationStepOne = formBuilder.group({
            fullname: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].minLength(1), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].maxLength(50), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required])],
            ...
            email: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].maxLength(50), regValidator.mailFormat()])]
        });
        ...
        this.FormRegistrationStepTwo = formBuilder.group({
            username: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].minLength(1), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].maxLength(50), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].pattern('^$|^[A-Za-z0-9]+'), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required]), regValidator.checkuniquevalueoffield('username', 1).bind(regValidator)],
    ...
    RegistrationPage.prototype.gotoSecondStep = function () {
        ...
        if (stepOneform.email) {
            this.remotService.checkifemailExist(data).subscribe(function (response) {
                if (response.success == 1) {
                    if (_this.FormRegistrationStepOne.valid) {
                        _this.regStep = 2;
                        _this.submitAttempt = false;
                    }
                }
                else {
                    _this.remotService.presentToast('This email is already registered on another CreoYou account');
                }
            });
        }
        else {
    ...
    RegistrationPage.prototype.showCategoryModal = function () {
        var _this = this;
        var categoryModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_4__pages_categories_categories__["a" /* CategoriesPage */], { usertype: this.userType });
        categoryModal.onDidDismiss(function (data) {
            if (data.hasOwnProperty("id")) {
                //console.log("GOt from modal", data);
    ...
    RegistrationPage.prototype.verifyOtp = function () {
        ...
        this.remotService.presentLoading();
        this.remotService.postData(this.otpParams, 'userOtpcheck').subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (response.success == 1) {
                ...
                _this.remotService.presentToast('OTP verification failed');
            }
        }, function () {
            _this.remotService.dismissLoader();
            _this.remotService.presentToast('OTP verification failed');
    ...
    RegistrationPage.prototype.googleLogIn = function () {
        ...
        this.googlePlus.login({
            ...
            .then(function (res) {
            _this.googlePlus.disconnect().then(function () {
            });
    ...
    RegistrationPage.prototype.changeMobilenumber = function () {
        var _this = this;
        var stepTwoform = this.FormRegistrationStepTwo.value;
        if (this.mobilenumber) {
            var data = {
        ...
        // console.log(data);
        var myModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_10__pages_changemobilenumber_changemobilenumber__["a" /* ChangemobilenumberPage */], { changedata: data });
        myModal.onDidDismiss(function (data) {
            //console.log("GOt from modal", data);
            // console.log(data);
            _this.FormRegistrationStepTwo.get('mobileno').setValue(data.mobileno);
            _this.mobilenumber = data.mobileno;
        });
        myModal.present();
    };
...
var SocialregPage = (function () {
    function SocialregPage(navCtrl, navParams, formBuilder, remotService, modalCtrl, regValidator, events) {
        ...
        this.FormRegistrationStepOne = formBuilder.group({
            ...
            username: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].maxLength(50), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].pattern('^$|^[A-Za-z0-9]+'), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required]),
    ...
    SocialregPage.prototype.showCategoryModal = function () {
        var _this = this;
        var categoryModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_4__pages_categories_categories__["a" /* CategoriesPage */], { usertype: this.user_type });
        categoryModal.onDidDismiss(function (data) {
            // Do things with data coming from modal, for instance :
            if (data.hasOwnProperty("id")) {
                //console.log("GOt from modal", data);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_jobapply_jobapply__ = __webpack_require__(271);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__otherprofile_otherprofile__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var JobdetailsPage = (function () {
    ...
    JobdetailsPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_searchfilter_searchfilter__ = __webpack_require__(276);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_jobdetails_jobdetails__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_otherprofile_otherprofile__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_http__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__home_home__ = __webpack_require__(62);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SearchPage = (function () {
    function SearchPage(alertCtrl, app, remotService, events, navCtrl, navParams, http) {
        this.alertCtrl = alertCtrl;
        this.app = app;
        this.remotService = remotService;
        this.events = events;
    ...
    SearchPage.prototype.initsearch = function () {
        ...
        if (this.advsearch) {
            ...
            this.remotService.presentLoading();
            this.http.get(url + "?" + params).map(function (res) { return res.json(); }).subscribe(function (data) {
                _this.remotService.dismissLoader();
                if (data.searchBy == 'job') {
                    data.allJobs.forEach(function (item) {
                ...
                if (data.searchBy == 'peopleName') {
                    for (var i = 0; i < data.peopleSettings.length; i++) {
                        ...
                        _this.people_user.push(data.allPeoples[i]);
                    }
                ...
                if (data.searchBy == 'businessName') {
                    for (var j = 0; j < data.businessSettings.length; j++) {
                        ...
                        _this.business_user.push(data.allBusiness[j]);
                    }
            ...
            this.remotService.postData(DataToSend, 'searchDetails').subscribe(function (response) {
                ...
                if (response.success == 1) {
                    ...
                    _this.jobs_user = [];
                    //console.log(this.business_user);
                    response.data.JobSearch.forEach(function (item, key, index) {
                        var date1 = item.creation_date;
                        var date2 = _this.date;
                        var diffInMs = Date.parse(date2) - Date.parse(date1);
                        var difinsec = Math.floor(diffInMs / 1000);
                        var diffmin = Math.floor(diffInMs / 1000 / 60);
    ...
    SearchPage.prototype.sendRequest = function (connection) {
        ...
        if (connection.can_sent_friend_request_by_mobile == 1) {
            ...
            this.remotService.postData(DataToSend, 'sendRequset').subscribe(function (response) {
                if (response.success == 1) {
                    _this.initsearch();
                    _this.remotService.presentToast('Connection request sent');
                }
                else {
                    _this.remotService.presentToast('Connection request sending failed');
                }
            }, function () {
                _this.remotService.presentToast('Error loading data.');
            });
    ...
    SearchPage.prototype.OtherFrofileView = function (connection) {
        if (connection.id == this.user_id) {
            ...
            this.app.getRootNav().push(__WEBPACK_IMPORTED_MODULE_5__pages_otherprofile_otherprofile__["a" /* OtherprofilePage */], { 'otheruserfrofiledata': data });
        }
    };
    ...
    SearchPage.prototype.OtherProfile = function (job) {
        var data = {
            user_id: job.id
        };
        //this.navCtrl.push(OtherprofilePage, { 'otheruserfrofiledata': data });
    };
    SearchPage.prototype.EntermobilenoSendRequest = function (connection) {
        var _this = this;
        var alert = this.alertCtrl.create({
            title: 'Send Friend Request',
            inputs: [
...
SearchPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-search',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\search\search.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar class="Cero_search">\n    <ion-searchbar placeholder="People,Business,Job..." [(ngModel)]="searchQuery" (change)="search()"></ion-searchbar>\n  </ion-navbar>\n\n  <!--ion-row class="search_by">\n    <ion-col col-3 (click)="All()">\n      <span [class.active]="all">All</span>\n    </ion-col>\n    <ion-col col-3 (click)="People()">\n      <span [class.active]="people">People</span>\n    </ion-col>\n    <ion-col col-3 (click)="Business()">\n      <span [class.active]="business">Business</span>\n    </ion-col>\n    <ion-col col-3 (click)="Jobs()">\n      <span [class.active]="jobs">Jobs</span>\n    </ion-col>\n  </ion-row-->\n\n  <ion-segment (ionChange)="segmentChanged($event)" [(ngModel)]="searchbycatagory">\n    <ion-segment-button value="all">\n      All\n    </ion-segment-button>\n    <ion-segment-button value="people">\n      People\n    </ion-segment-button>\n    <ion-segment-button value="business">\n      Business\n    </ion-segment-button>\n    <ion-segment-button value="job">\n      Jobs\n    </ion-segment-button>\n  </ion-segment>\n\n</ion-header>\n\n\n<ion-content class="has-header">\n\n\n  <div [ngSwitch]="searchbycatagory">\n\n    <!-- search_by all-->\n    <div *ngSwitchCase="\'all\'">\n      <!-- people-->\n\n      <h3 class="search_heading">People</h3>\n      <h4 class="notFound" *ngIf="people_user==\'\'"> No Result Found... </h4>\n      <ion-list *ngFor="let people of people_user; let i=index">\n\n        <ion-item padding-horizontal class="search_user search_user_individual" *ngIf="i<3">\n          <ion-avatar item-left (click)="OtherFrofileView(people)">\n            <img *ngIf="people.image" img-preloader="{{base_url}}uploads/profileImages/resizedImages/{{people.image}}" alt="Image" />\n            <img *ngIf="people.image==\'\' || people.image==null" img-preloader="assets/img/management.png" alt="Image" />\n            <div *ngIf="people.premium_user==1" class="premimum_badge"></div>\n          </ion-avatar>\n\n          <ion-item class="search_right">\n            <div (click)="OtherFrofileView(people)">\n              <p *ngIf="people.users_full_name">{{people.users_full_name}}</p>\n\n              <p class="user_deg" *ngIf="people.cat_name">\n                <ion-icon name="briefcase"></ion-icon> {{people.cat_name}}</p>\n              <p class="user_deg" *ngIf="people.cat_name==\'\' || people.cat_name==null">\n                <ion-icon name="briefcase"></ion-icon> {{people.creativeField}}</p>\n              <p class="user_deg" *ngIf="people.city">\n                <ion-icon name="home" *ngIf="people.state || people.country"></ion-icon>\n                <span *ngIf="people.country"> {{people.country}}</span>\n                <span *ngIf="people.state"> {{people.state}}</span>\n\n              </p>\n            </div>\n            <div class="user_action" item-right *ngIf="user_id!=people.id">\n              <button [disabled]="people.friend==1 || people.follower==1 || people.is_friend==1" ion-button block icon-right (click)="sendRequest(people)">\n                <ion-icon ios="ios-person-add" md="md-person-add"></ion-icon> Add</button>\n              <button ion-button block icon-right [disabled]="people.friend==1 || people.follower==1 || people.is_friend==1" (click)="sendfollowingRequest(people)">\n                <i class="material-icons">forward</i> Follow</button>\n            </div>\n          </ion-item>\n        </ion-item>\n      </ion-list>\n\n      <!-- Business-->\n\n      <h3 class="search_heading">Business</h3>\n      <h4 class="notFound" *ngIf="business_user==\'\'"> No Result Found... </h4>\n      <ion-list *ngFor="let business of business_user; let i=index">\n\n        <ion-item padding-horizontal class="search_user search_user_individual" *ngIf="i<3">\n          <ion-avatar item-left (click)="OtherFrofileView(business)">\n            <img *ngIf="business.image" img-preloader="{{base_url}}uploads/profileImages/resizedImages/{{business.image}}" alt="Image"\n            />\n            <img *ngIf="business.image==\'\' || business.image==null" img-preloader="assets/img/management.png" alt="Image" />\n            <div *ngIf="business.premium_user==1" class="premimum_badge"></div>\n\n\n          </ion-avatar>\n\n          <ion-item class="search_right">\n            <div (click)="OtherFrofileView(business)">\n              <p>{{business.buisness_name}}</p>\n              <p class="user_deg" *ngIf="business.cat_name">\n                <ion-icon name="briefcase"></ion-icon> {{business.cat_name}}</p>\n              <p class="user_deg" *ngIf="business.creativeField">\n                <ion-icon name="briefcase"></ion-icon> {{business.creativeField}}</p>\n\n              <p class="user_deg" *ngIf="business.city">\n                <ion-icon name="home" *ngIf="business.state || business.country"></ion-icon>\n                <span *ngIf="business.country"> {{business.country}}</span>\n                <span *ngIf="business.state"> {{business.state}}</span>\n\n              </p>\n            </div>\n            <div class="user_action" item-right *ngIf="user_id!=business.id">\n              <button [disabled]="business.friend==1 || business.follower==1 || business.is_friend==1" ion-button block icon-right (click)="sendRequest(business)">\n                <ion-icon ios="ios-person-add" md="md-person-add"></ion-icon> Add </button>\n              <button ion-button block icon-right [disabled]="business.friend==1 || business.follower==1 || business.is_friend==1" (click)="sendfollowingRequest(business)">\n                <i class="material-icons">forward</i> Follow </button>\n            </div>\n          </ion-item>\n        </ion-item>\n      </ion-list>\n\n      <!-- job-->\n      <h3 class="search_heading">Job</h3>\n      <h4 class="notFound" *ngIf="jobs_user==\'\'"> No Result Found... </h4>\n      <ion-list *ngFor="let jobs of jobs_user; let i=index">\n\n        <ion-item padding-horizontal class="search_user search_user_individual" *ngIf="i<3" (click)="jobdetails(jobs)">\n          <ion-avatar item-left>\n            <img *ngIf="jobs.image!=\'\' && jobs.image!=null" img-preloader="{{base_url}}uploads/profileImages/resizedImages/{{jobs.image}}"\n            />\n            <img *ngIf="jobs.image==\'\' || jobs.image==null" img-preloader="assets/img/management.png" />\n\n          </ion-avatar>\n\n          <ion-item class="search_right">\n            <p class="Company_name" *ngIf="jobs.buisness_name">{{jobs.buisness_name}}</p>\n            <p class="Company_name" *ngIf="jobs.fname">{{jobs.fname}} {{jobs.lname}}</p>\n            <p *ngIf="jobs.job_title">\n              <ion-icon name="briefcase"></ion-icon> {{jobs.job_title}}</p>\n            <p class="user_deg"> Required Experience : {{jobs.required_experience}} </p>\n            <p class="user_deg" *ngIf="jobs.cat_name">{{jobs.cat_name}}</p>\n            <p class="user_deg" *ngIf="jobs.state || jobs.country">\n              <span *ngIf="jobs.country">{{jobs.country}}</span>\n              <span *ngIf="jobs.state"> {{jobs.state}}</span>\n\n            </p>\n            <p class="user_deg" *ngIf="jobs.second<60">{{jobs.second }} Second ago | {{jobs.jobtype}}</p>\n            <p class="user_deg" *ngIf="jobs?.minute<60 && jobs.second>60">{{jobs?.minute }} Minute ago | {{jobs.jobtype}}</p>\n            <p class="user_deg" *ngIf="jobs.hour<24 && jobs.minute>60">{{jobs.hour}} hours ago | {{jobs.jobtype}}</p>\n            <p class="user_deg" *ngIf="jobs.hour>24 && jobs.weeks<2">{{jobs.days}} Days ago | {{jobs.jobtype}}</p>\n            <p class="user_deg" *ngIf="jobs.weeks>1">{{jobs.weeks}} Weeks ago | {{jobs.jobtype}}</p>\n            <div class="user_action" item-right>\n              <img *ngIf="jobs.is_ad==1" img-preloader="assets/img/ad.png" alt="Image" />\n            </div>\n\n          </ion-item>\n        </ion-item>\n\n      </ion-list>\n\n    </div>\n\n\n\n    <!-- search_by people-->\n\n    <div *ngSwitchCase="\'people\'">\n\n      <h4 class="filter" (click)="searchfilter()">\n        <ion-icon md="md-funnel"></ion-icon> Filter\n      </h4>\n      <h4 class="notFound">\n        <ion-spinner name="dots" *ngIf="people_user==\'\'"></ion-spinner>\n      </h4>\n      <ion-list *ngFor="let people of people_user">\n\n        <ion-item padding-horizontal class="search_user search_user_individual">\n          <ion-avatar item-left (click)="OtherFrofileView(people)">\n            <img *ngIf="people?.image" img-preloader="{{base_url}}uploads/profileImages/resizedImages/{{people.image}}" alt="Image" />\n            <img *ngIf="people?.image==\'\' || people?.image==null && people?.profile?.image==null" img-preloader="assets/img/management.png"\n              alt="Image" />\n            <div *ngIf="people.premium_user==1" class="premimum_badge"></div>\n          </ion-avatar>\n          <ion-item class="search_right">\n            <div (click)="OtherFrofileView(people)">\n              <p *ngIf="people.fname">{{people.fname}} {{people.lname}}</p>\n\n              <p class="user_deg" *ngIf="people.cat_name">\n                <ion-icon name="briefcase"></ion-icon> {{people.cat_name}}</p>\n              <p class="user_deg" *ngIf="people.cat_name==\'\' || people.cat_name==null">\n                <ion-icon name="briefcase"></ion-icon> {{people.creativeField}}</p>\n              <p class="user_deg" *ngIf="people.state || people.country">\n                <ion-icon name="home"></ion-icon>\n                <span *ngIf="people.country"> {{people.country}}</span>\n                <span *ngIf="people.state"> {{people.state}}</span>\n\n              </p>\n\n            </div>\n            <div class="user_action" item-right *ngIf="user_id!=people.id">\n              <button [disabled]="people.friend==1 || people.follower==1 || people.is_friend==1" ion-button block icon-right (click)="sendRequest(people)">\n                <ion-icon ios="ios-person-add" md="md-person-add"></ion-icon> Add </button>\n              <button ion-button block icon-right [disabled]="people.friend==1 || people.follower==1 ||  people.is_friend==1" (click)="sendfollowingRequest(people)">\n                <i class="material-icons">forward</i> Follow </button>\n            </div>\n          </ion-item>\n        </ion-item>\n      </ion-list>\n\n\n\n    </div>\n\n    <!-- search_by business-->\n\n\n    <div *ngSwitchCase="\'business\'">\n      <h4 class="filter" (click)="searchfilter()">\n        <ion-icon md="md-funnel"></ion-icon> Filter\n      </h4>\n      <h4 class="notFound">\n        <ion-spinner name="dots" *ngIf="business_user==\'\'"></ion-spinner>\n      </h4>\n      <ion-list *ngFor="let business of business_user">\n\n        <ion-item padding-horizontal class="search_user search_user_individual">\n          <ion-avatar item-left (click)="OtherFrofileView(business)">\n            <img *ngIf="business.image!=\'\' && business.image!=null" img-preloader="{{base_url}}uploads/profileImages/resizedImages/{{business.image}}"\n              alt="Image" />\n            <img *ngIf="business.image==\'\' || business.image==null" img-preloader="assets/img/management.png" alt="Image" />\n            <div *ngIf="business.premium_user==1" class="premimum_badge"></div>\n          </ion-avatar>\n\n          <ion-item class="search_right">\n            <div (click)="OtherFrofileView(business)">\n              <p *ngIf="business.buisness_name">{{business.buisness_name}}</p>\n\n              <p class="user_deg" *ngIf="business.cat_name">\n                <ion-icon name="briefcase"></ion-icon> {{business?.cat_name}}</p>\n\n              <p class="user_deg" *ngIf="business.creativeField">\n                <ion-icon name="briefcase"></ion-icon> {{business?.creativeField}}</p>\n\n\n              <p class="user_deg" *ngIf="business.city">\n                <ion-icon name="home" *ngIf="business.state || business.country"></ion-icon>\n                <span *ngIf="business.country">{{business.country}}</span>\n                <span *ngIf="business.state"> {{business.state}}</span>\n\n              </p>\n            </div>\n            <div class="user_action" item-right *ngIf="user_id!=business.id">\n              <button [disabled]="business.friend==1 || business.follower==1 || business.is_friend==1" ion-button block icon-right (click)="sendRequest(business)">\n                <ion-icon ios="ios-person-add" md="md-person-add"></ion-icon> Add </button>\n              <button ion-button block icon-right [disabled]="business.friend==1 || business.follower==1 || business.is_friend==1" (click)="sendfollowingRequest(business)">\n                <i class="material-icons">forward</i> Follow </button>\n            </div>\n          </ion-item>\n        </ion-item>\n\n      </ion-list>\n\n    </div>\n\n    <!-- search_by job-->\n\n\n    <div *ngSwitchCase="\'job\'">\n      <h4 class="filter" (click)="searchfilter()">\n        <ion-icon md="md-funnel"></ion-icon> Filter\n      </h4>\n      <h4 class="notFound">\n        <ion-spinner name="dots" *ngIf="business_user==\'\'"></ion-spinner>\n      </h4>\n      <ion-list *ngFor="let jobs of jobs_user">\n\n        <ion-item padding-horizontal class="search_user search_user_individual">\n          <ion-avatar item-left>\n            <img *ngIf="jobs.image" img-preloader="{{base_url}}uploads/profileImages/resizedImages/{{jobs.image}}" alt="Image" />\n            <img *ngIf="jobs.image==\'\' || jobs.image==null" img-preloader="assets/img/management.png" alt="Image" />\n\n\n          </ion-avatar>\n          <ion-item class="search_right">\n            <p class="Company_name" (click)="OtherProfile(jobs)" *ngIf="jobs.buisness_name">{{jobs.buisness_name}}</p>\n            <p class="Company_name" (click)="OtherProfile(jobs)" *ngIf="jobs.fname">{{jobs.fname}} {{jobs.lname}}</p>\n            <div (click)="jobdetails(jobs)">\n              <p *ngIf="jobs.job_title">\n                <ion-icon name="briefcase"></ion-icon> {{jobs.job_title}}</p>\n              <p class="user_deg"> Required Experience : {{jobs.required_experience}} </p>\n              <p class="user_deg" *ngIf="jobs.cat_name">{{jobs.cat_name}}</p>\n              <p class="user_deg" *ngIf="jobs.state || jobs.country">\n                <span *ngIf="jobs.country">{{jobs.country}}</span>\n                <span *ngIf="jobs.state"> {{jobs.state}}</span>\n\n              </p>\n              <p class="user_deg" *ngIf="jobs.second<60">{{jobs.second }} Second ago | {{jobs.jobtype}}</p>\n              <p class="user_deg" *ngIf="jobs.minute<60 && jobs.second>60">{{jobs.minute }} Minute ago | {{jobs.jobtype}}</p>\n              <p class="user_deg" *ngIf="jobs.hour<24 && jobs.minute>60">{{jobs.hour}} hours ago | {{jobs.jobtype}}</p>\n              <p class="user_deg" *ngIf="jobs.hour>24 && jobs.weeks<2">{{jobs.days}} Days ago | {{jobs.jobtype}}</p>\n              <p class="user_deg" *ngIf="jobs.weeks>1">{{jobs.weeks}} Weeks ago | {{jobs.jobtype}}</p>\n            </div>\n            <div class="user_action" item-right>\n              <img *ngIf="jobs.is_ad==1" img-preloader="assets/img/ad.png" alt="Image" />\n            </div>\n\n          </ion-item>\n        </ion-item>\n      </ion-list>\n    </div>\n  </div>\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\search\search.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* App */], __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_6__angular_http__["a" /* Http */]])
], SearchPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_audio__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_social_sharing__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__comment_comment__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__aboutme_aboutme__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__portfolio_portfolio__ = __webpack_require__(260);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_messagedetails_messagedetails__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_otherprofileconnections_otherprofileconnections__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_otherprofileevents_otherprofileevents__ = __webpack_require__(263);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__home_home__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__angular_platform_browser__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_eventdetails_eventdetails__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_native_photo_viewer__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_photoview_photoview__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_audiodetails_audiodetails__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__videodetails_videodetails__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__ionic_native_streaming_media__ = __webpack_require__(39);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var OtherprofilePage = (function () {
    function OtherprofilePage(streamingMedia, photoViewer, _DomSanitizer, alertCtrl, modalCtrl, socialSharing, _audioProvider, remotService, events, navCtrl, navParams) {
    ...
    OtherprofilePage.prototype.gotoPhotoView = function (albumview) {
        var album = {
            id: albumview.album_id
        };
        // console.log(albumview);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_15__pages_photoview_photoview__["a" /* PhotoviewPage */], { "album": album, "img_id": albumview.id, 'touserid': this.otherprofiledata.user_id, "parentPage": this });
    };
    /*  zoomImage(imageData) {
    ...
    OtherprofilePage.prototype.zoomProfileImage = function (imageData) {
        var imagezoom = this.base_url + 'uploads/profileImages/' + imageData.incident_details;
        //console.log('zoom image', imageData);
        this.photoViewer.show(imagezoom, '', { share: false });
    };
    OtherprofilePage.prototype.zoomStatusImage = function (imageData) {
        var imagezoom = this.base_url + 'uploads/statusMedia/' + imageData.media_name;
        //console.log('zoom image', imageData);
        this.photoViewer.show(imagezoom, '', { share: false });
    };
    ...
    OtherprofilePage.prototype.playThisTrack = function (event, track) {
        if (track.select) {
            track.select = false;
            this.videoPlayer.forEach(function (i) {
        ...
        for (var i = 0; i < this.arr.length; i++) {
            if (this.currentTrackNumber != this.arr[i]) {
                ...
                for (var _i = 0, _a = this.homeData; _i < _a.length; _i++) {
                    var g = _a[_i];
                    // item.incident_type==='Audio'
                    if (g.incident_type == 'Audio') {
                        for (var _b = 0, _c = g.myTracks; _b < _c.length; _b++) {
                            var xc = _c[_b];
                            if (xc.id != track.id) {
                                xc.select = true;
                            }
    ...
    OtherprofilePage.prototype.playvideo = function (g) {
        this._audioProvider.stop();
        for (var _i = 0, _a = this.homeData; _i < _a.length; _i++) {
            var g_1 = _a[_i];
            // item.incident_type==='Audio'
            if (g_1.incident_type == 'Audio') {
                for (var _b = 0, _c = g_1.myTracks; _b < _c.length; _b++) {
                    var xc = _c[_b];
                    xc.select = true;
                }
            }
        }
        var url = this.base_url + 'uploads/portfolioVideos/' + g;
        var options = {
    ...
    OtherprofilePage.prototype.otheruserAbout = function (profileinfo) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__aboutme_aboutme__["a" /* AboutmePage */], { 'touserid': profileinfo.userid, 'usertype': profileinfo.user_type });
    };
    OtherprofilePage.prototype.otheruserPortfolio = function (profileinfo) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__portfolio_portfolio__["a" /* PortfolioPage */], { 'touserid': profileinfo.userid, 'usertype': this.otherprofiledata.user_type });
    };
    OtherprofilePage.prototype.otheruserConnection = function (profileinfo) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_9__pages_otherprofileconnections_otherprofileconnections__["a" /* OtherprofileconnectionsPage */], { 'touserid': profileinfo.userid, 'usertype': this.otherprofiledata.user_type });
    };
    OtherprofilePage.prototype.GotoMessage = function (profileinfo) {
        ...
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_8__pages_messagedetails_messagedetails__["a" /* MessagedetailsPage */], { user: connection, "parentPage": this });
    };
    OtherprofilePage.prototype.GotoHome = function () {
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_11__home_home__["a" /* HomePage */]);
    };
    OtherprofilePage.prototype.otherUserEvents = function (profileinfo) {
        var events = {
            user_id: profileinfo.userid,
            image: profileinfo.image
        };
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_10__pages_otherprofileevents_otherprofileevents__["a" /* OtherprofileeventsPage */], { 'events': events, "parentPage": this });
    };
    /**
     * send request to a friend
     * @param connection
     */
    OtherprofilePage.prototype.sendRequest = function (profileinfo) {
        var _this = this;
        if (profileinfo.can_sent_friend_request_by_mobile == 1) {
            ...
            this.remotService.postData(DataToSend, 'sendRequset').subscribe(function (response) {
                if (response.success == 1) {
                    _this.initOtherprofiledata();
                    _this.remotService.presentToast('Connection request sent successfully');
                }
            }, function () {
                _this.remotService.presentToast('Error loading data.');
            });
    ...
    OtherprofilePage.prototype.sendfollowingRequest = function (profileinfo) {
        var _this = this;
        var DataToSend = {
            user_id: window.localStorage['userid'],
    ...
    OtherprofilePage.prototype.ionViewWillLeave = function () {
        this._audioProvider.stop();
        this.remotService.dismissLoader();
    };
    ...
    * @param item
    */
    OtherprofilePage.prototype.modiFyitemasnecessary = function (item) {
    ...
    OtherprofilePage.prototype.EntermobilenoSendRequest = function (profileinfo) {
        var _this = this;
        var alert = this.alertCtrl.create({
            title: 'Send Friend Request',
            inputs: [
    ...
    OtherprofilePage.prototype.addtocalendarEvent = function (item) {
        var _this = this;
        var DataToSends = {
            userId: window.localStorage['userid'],
        ...
        this.remotService.postData(DataToSends, 'addToCalender').subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (response.success == 1) {
                _this.remotService.presentToast('Event Added in Calender Successfully!');
            }
            else {
                _this.remotService.presentToast(response.message);
            }
    ...
    OtherprofilePage.prototype.eventDetails = function (event) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_13__pages_eventdetails_eventdetails__["a" /* EventdetailsPage */], { 'eventdetails': event });
    };
    OtherprofilePage.prototype.audiodetails = function (track) {
        //console.log(track);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_16__pages_audiodetails_audiodetails__["a" /* AudiodetailsPage */], { audiodetails: track });
    };
    OtherprofilePage.prototype.videodetails = function (track) {
        // console.log(track);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_17__videodetails_videodetails__["a" /* VideodetailsPage */], { videodetails: track });
    };
...
var map = {
	...
	"../pages/advertisementdetails/advertisementdetails.module": [
		527,
		53
	],
	...
	"../pages/audiodetails/audiodetails.module": [
		530,
		50
	],
	...
	"../pages/changemobilenumber/changemobilenumber.module": [
		534,
		46
	],
	...
	"../pages/otherprofileconnections/otherprofileconnections.module": [
		557,
		23
	],
	"../pages/otherprofileevents/otherprofileevents.module": [
		558,
		22
	],
	...
	"../pages/photodetails/photodetails.module": [
		561,
		19
	],
	...
	"../pages/premiumuser/premiumuser.module": [
		566,
		14
	],
	...
	"../pages/profilecomplete/profilecomplete.module": [
		568,
		12
	],
	...
	"../pages/visitedprofile/visitedprofile.module": [
		579,
		1
	],
...
var AbouteditPage = (function () {
    function AbouteditPage(navCtrl, navParams, events, actionSheetCtrl, remotService, modalCtrl) {
        ...
        this.eduunivercity = '';
        this.edudegree = '';
        this.edustrtmonth = 'Jan';
        this.edustrtyear = 2000;
        this.eduendmonth = 'Jan';
        this.eduendyear = 2007;
        this.eduwebsite = '';
        this.edudetail = '';
        this.eduid = 0;
        //work params
        this.wrkpositn = '';
        this.wrkcompny = '';
        this.wrkstrtmonth = 'Jan';
        this.wrkstrtyear = 2000;
        this.wrkendmonth = 'Jan';
        this.wrkendyear = 2007;
        this.wrkwebsite = '';
        this.wrkdetail = '';
        this.wrkid = 0;
        this.statement = null;
    ...
    /* company overview */
    AbouteditPage.prototype.saveCompanyOverview = function () {
        var _this = this;
        if (this.companyoverview == '') {
            ...
            this.remotService.presentLoading();
            this.remotService.postData(data, 'editCompanyOverView').subscribe(function (response) {
                _this.remotService.dismissLoader();
                if (response.success == 1) {
                    _this.navParams.get("parentPage").initviewaboutData();
                    // this.events.publish('creoyou:showmenu');
    ...
    AbouteditPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_albumview_albumview__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_file_transfer__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_file_opener__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_social_sharing__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_videocomment_videocomment__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_ionic_audio__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_audiocomment_audiocomment__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_audiodetails_audiodetails__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_videodetails_videodetails__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__angular_platform_browser__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__ionic_native_streaming_media__ = __webpack_require__(39);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PortfolioPage = (function () {
    function PortfolioPage(streamingMedia, _DomSanitizer, events, _audioProvider, modalCtrl, socialSharing, fileOpener, platform, file, filePath, transfer, remotService, navCtrl, navParams) {
        this.streamingMedia = streamingMedia;
        this._DomSanitizer = _DomSanitizer;
        this.events = events;
        this._audioProvider = _audioProvider;
    ...
    PortfolioPage.prototype.initPhotoalbumData = function () {
        var _this = this;
        var DataToSend = {
            user_id: window.localStorage['userid'],
            other_user_id: this.touserid,
    ...
    PortfolioPage.prototype.playThisTrack = function (event, track) {
        if (track.select) {
            track.select = false;
        }
        else {
        ...
        for (var i = 0; i < this.arr.length; i++) {
            if (this.currentTrackNumber != this.arr[i]) {
                ...
                for (var _i = 0, _a = this.allmyaudios; _i < _a.length; _i++) {
                    var g = _a[_i];
                    for (var _b = 0, _c = g.myTracks; _b < _c.length; _b++) {
                        var xc = _c[_b];
                        if (xc.id != track.id) {
    ...
    PortfolioPage.prototype.playvideo = function (g) {
        this._audioProvider.stop();
        for (var _i = 0, _a = this.allmyaudios; _i < _a.length; _i++) {
            var g_1 = _a[_i];
            for (var _b = 0, _c = g_1.myTracks; _b < _c.length; _b++) {
    ...
    PortfolioPage.prototype.audiodetails = function (track) {
        // console.log(track);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_12__pages_audiodetails_audiodetails__["a" /* AudiodetailsPage */], { audiodetails: track });
    };
    PortfolioPage.prototype.videodetails = function (vdo) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_13__pages_videodetails_videodetails__["a" /* VideodetailsPage */], { videodetails: vdo });
    };
    PortfolioPage.prototype.initvideo = function () {
        var _this = this;
        var DataToSend = {
            user_id: window.localStorage['userid'],
            other_user_id: this.touserid,
    ...
    PortfolioPage.prototype.likeThisvideo = function (vdo) {
        var _this = this;
    ...
    /**
       ...
       * @param item
       */
    PortfolioPage.prototype.shareThisPost = function (vdo) {
        var link = '';
  ...
  * show comments
  */
    PortfolioPage.prototype.showComments = function (vdo) {
        var commentModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_9__pages_videocomment_videocomment__["a" /* VideocommentPage */], { incidentitem: vdo });
        commentModal.onDidDismiss(function (data) {
            vdo.comments = data.commentlength;
        });
        commentModal.present();
    };
    PortfolioPage.prototype.gotoPhotoView = function (album) {
        this.otherportfolio = true;
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__pages_albumview_albumview__["a" /* AlbumviewPage */], { "album": album, 'touserid': this.touserid, "parentPage": this });
    };
    PortfolioPage.prototype.initaudio = function () {
        var _this = this;
        var DataToSend = {
            user_id: window.localStorage['userid'],
            other_user_id: this.touserid,
        ...
        this.remotService.postData(DataToSend, 'mediaListing').subscribe(function (response) {
            ...
            // console.log(response);
            response.data.forEach(function (item, key, index) {
                var audiosource = (item.audio_source != null && item.audio_source != '') ? item.audio_name : _this.base_url + item.audio_name;
                item.myTracks = [{
                        src: audiosource,
                        artist: 'No Artist',
                        title: item.audio_title,
    ...
    PortfolioPage.prototype.likeThisaudio = function (track) {
        var _this = this;
        var DataToSend = {
            user_id: window.localStorage['userid'],
            token: window.localStorage['token'],
    ...
    * show comments
    */
    PortfolioPage.prototype.showCommentsaudio = function (track) {
        var commentModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_11__pages_audiocomment_audiocomment__["a" /* AudiocommentPage */], { incidentitem: track });
        commentModal.onDidDismiss(function (data) {
    ...
    /**
         ...
         * @param item
         */
    PortfolioPage.prototype.shareThisudio = function (track) {
    ...
    PortfolioPage.prototype.ionViewWillLeave = function () {
        this._audioProvider.stop();
        this.remotService.dismissLoader();
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */])
], PortfolioPage.prototype, "content", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], PortfolioPage.prototype, "navBar", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChildren"])('videoPlayer'),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["QueryList"])
], PortfolioPage.prototype, "videoPlayer", void 0);
PortfolioPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_15__ionic_native_streaming_media__["a" /* StreamingMedia */], __WEBPACK_IMPORTED_MODULE_14__angular_platform_browser__["DomSanitizer"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_10_ionic_audio__["a" /* AudioProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */], __WEBPACK_IMPORTED_MODULE_8__ionic_native_social_sharing__["a" /* SocialSharing */], __WEBPACK_IMPORTED_MODULE_7__ionic_native_file_opener__["a" /* FileOpener */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* Platform */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__["a" /* File */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_file_path__["a" /* FilePath */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_file_transfer__["a" /* FileTransfer */], __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], PortfolioPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_taguser_taguser__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_messages_messages__ = __webpack_require__(82);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NewmessagePage = (function () {
    function NewmessagePage(events, remotService, modalCtrl, navCtrl, navParams) {
        this.events = events;
        this.remotService = remotService;
        this.modalCtrl = modalCtrl;
        this.navCtrl = navCtrl;
    ...
    NewmessagePage.prototype.searchConnection = function () {
        /*Invite connection for event */
        var _this = this;
        var connectionModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_2__pages_taguser_taguser__["a" /* TaguserPage */], { pagename: 'Search your connections' });
        connectionModal.onDidDismiss(function (data) {
            if (data.tags.length > 0) {
                data.tags.forEach(function (item) {
                    _this.statustags = item.user_id;
                    _this.username = item.users_full_name;
                });
            }
    ...
    NewmessagePage.prototype.sendMessage = function () {
        ...
        this.remotService.postData(sendTextparams, 'sendMessages').subscribe(function (response) {
            if (response.success == 1) {
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__pages_messages_messages__["a" /* MessagesPage */]);
            }
            else {
                _this.remotService.presentToast(response.message);
            }
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], NewmessagePage.prototype, "navBar", void 0);
NewmessagePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-newmessage',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\newmessage\newmessage.html"*/'<ion-header class="creoyou-header">\n\n    <ion-navbar>\n        <ion-title>Compose</ion-title>\n    </ion-navbar>\n\n    <ion-toolbar class="chatSearch">\n        <ion-searchbar placeholder="Search for people ..." (click)="searchConnection()"></ion-searchbar>\n    </ion-toolbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n\n    <ion-list>\n\n        <ion-item>\n            <ion-input placeholder="To" type="text" [(ngModel)]="username"></ion-input>\n        </ion-item>\n\n        <ion-item>\n            <ion-textarea rows="5" placeholder="Type you Messages here ..." [(ngModel)]="messageText"></ion-textarea>\n        </ion-item>\n\n\n    </ion-list>\n\n\n</ion-content>\n<ion-footer>\n    <ion-toolbar class="button_bottom_top">\n        <a class="sign-up button button-block button-stable" ui-sref="common.login" (click)="sendMessage()">SEND</a>\n    </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\newmessage\newmessage.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], NewmessagePage);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return OtherprofileconnectionsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_otherprofile_otherprofile__ = __webpack_require__(17);
 ...
 * Ionic pages and navigation.
 */
var OtherprofileconnectionsPage = (function () {
    function OtherprofileconnectionsPage(events, remotService, navCtrl, navParams) {
        this.events = events;
        this.remotService = remotService;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    OtherprofileconnectionsPage.prototype.segmentChanged = function (event) {
    ...
    OtherprofileconnectionsPage.prototype.initViewwithconnectionsdata = function () {
        var _this = this;
        this.shownone = 0;
        var searchparams = {
            user_id: this.touserid,
    ...
    OtherprofileconnectionsPage.prototype.loadFollowings = function () {
        var _this = this;
        this.followingOffset = 0;
        var followingparams = {
            user_id: this.touserid,
    ...
    OtherprofileconnectionsPage.prototype.loadFollowers = function () {
        var _this = this;
        this.followerOffset = 0;
        var followerParams = {
            user_id: this.touserid,
    ...
    OtherprofileconnectionsPage.prototype.OtherFrofileView = function (connection) {
        // console.log(connection);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__pages_otherprofile_otherprofile__["a" /* OtherprofilePage */], { 'otheruserfrofiledata': connection });
    };
    OtherprofileconnectionsPage.prototype.OtherProfile = function (user) {
        var data = {
            user_id: user.id
        };
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__pages_otherprofile_otherprofile__["a" /* OtherprofilePage */], { 'otheruserfrofiledata': data });
    ...
    OtherprofileconnectionsPage.prototype.initOtherFollowing = function () {
    };
    OtherprofileconnectionsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.events.publish('creoyou:hidemenu');
        //over ridding back button
        this.navBar.backButtonClick = function () {
    ...
    OtherprofileconnectionsPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
    return OtherprofileconnectionsPage;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], OtherprofileconnectionsPage.prototype, "navBar", void 0);
OtherprofileconnectionsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-otherprofileconnections',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\otherprofileconnections\otherprofileconnections.html"*/'<ion-header class="creoyou-header">\n\n\n  <ion-navbar>\n    <ion-title>Connection</ion-title>\n  </ion-navbar>\n\n  <ion-segment (ionChange)="segmentChanged($event)" [(ngModel)]="connectionandfollowing">\n    <ion-segment-button value="connections">\n      Connections\n    </ion-segment-button>\n    <ion-segment-button value="followings">\n      Following\n    </ion-segment-button>\n    <ion-segment-button value="followers">\n      Followers\n    </ion-segment-button>\n  </ion-segment>\n\n</ion-header>\n<ion-content>\n  <div [ngSwitch]="connectionandfollowing">\n    <ion-list *ngSwitchCase="\'connections\'" class="individual">\n\n      <ion-item *ngFor="let connection of connections;let idx=index;" padding-horizontal class="search_user search_user_individual">\n\n        <ion-avatar item-left (click)="OtherFrofileView(connection)">\n\n          <img *ngIf="connection.image!=null && connection.image!=\'\'" src="{{base_url}}uploads/profileImages/resizedImages/{{connection.image}}"\n            alt="avatar">\n          <img *ngIf="connection.image==null || connection.image==\'\'" src="assets/img/management.png" alt="avatar">\n\n        </ion-avatar>\n        <ion-item class="searcsh_right">\n          <div (click)="OtherFrofileView(connection)">\n            <p>{{connection.users_full_name}}</p>\n            <p class="user_deg">\n              {{connection.creativeField}}</p>\n            <p class="user_deg">\n              <ion-icon name="home"></ion-icon> {{connection.address}}</p>\n          </div>\n          <div class="user_action" item-right>\n            <!-- <ion-icon (click)="presentActionSheet(connection,idx)" item-right ios="ios-settings" md="md-settings"></ion-icon>\n            <button (click)="startMessage(connection,idx)" ion-button block icon-right>\n              <ion-icon name="mail"></ion-icon>Message\n            </button> -->\n          </div>\n        </ion-item>\n      </ion-item>\n\n      <ion-item *ngIf="connections?.length<=0 && shownone==1" class="no_result">\n        <h3> Sorry No Connection Found... </h3>\n      </ion-item>\n    </ion-list>\n\n\n\n    <ion-list *ngSwitchCase="\'followings\'">\n\n      <ion-item *ngIf="following?.length<=0" class="no_result">\n        <h3> Sorry No Following User Found... </h3>\n      </ion-item>\n\n      <ion-list class="individual">\n\n        <ion-item *ngFor="let user of following;let idx=index;" padding-horizontal class="search_user search_user_individual">\n          <ion-avatar item-left (click)="OtherProfile(user)">\n            <img *ngIf="user.image!=null && user.image!=\'\'" src="{{base_url}}uploads/profileImages/resizedImages/{{user.image}}" alt="avatar">\n            <img *ngIf="user.image==null || user.image==\'\'" src="assets/img/management.png" alt="avatar">\n\n          </ion-avatar>\n          <ion-item class="searcsh_right">\n            <div (click)="OtherProfile(user)">\n              <p>{{user.fname}} {{user.lname}}</p>\n              <p *ngIf="user.buisness_name">{{user.buisness_name}}</p>\n\n              <p class="user_deg">\n                <ion-icon name="briefcase"></ion-icon> {{user.creativeField}}</p>\n              <p class="user_deg">\n                <ion-icon name="home"></ion-icon> {{user.address}}</p>\n            </div>\n            <!--  <div class="user_action" (click)="presentActionSheet(user,1,idx);" item-right>\n              <ion-icon item-right ios="ios-settings" md="md-settings"></ion-icon>\n            </div> -->\n          </ion-item>\n        </ion-item>\n\n      </ion-list>\n\n      <ion-infinite-scroll (ionInfinite)="fetchFollowingData($event)">\n        <ion-infinite-scroll-content loadingSpinner="bubbles">\n        </ion-infinite-scroll-content>\n      </ion-infinite-scroll>\n\n    </ion-list>\n\n    <ion-list *ngSwitchCase="\'followers\'">\n\n      <ion-item *ngIf="followers?.length<=0" class="no_result">\n        <h3> Sorry No Follower Found... </h3>\n      </ion-item>\n\n      <ion-list class="individual">\n\n        <ion-item *ngFor="let user of followers;let idx=index;" padding-horizontal class="search_user search_user_individual">\n          <ion-avatar item-left (click)="OtherProfile(user)">\n            <img *ngIf="user.image!=null && user.image!=\'\'" src="{{base_url}}uploads/profileImages/resizedImages/{{user.image}}" alt="avatar">\n            <img *ngIf="user.image==null || user.image==\'\'" src="assets/img/management.png" alt="avatar">\n\n          </ion-avatar>\n          <ion-item class="searcsh_right">\n            <div (click)="OtherProfile(user)">\n              <p>{{user.fname}} {{user.lname}}</p>\n              <p *ngIf="user.buisness_name">{{user.buisness_name}}</p>\n              <p class="user_deg">\n                <ion-icon name="briefcase"></ion-icon> {{user.creativeField}}</p>\n              <p class="user_deg">\n                <ion-icon name="home"></ion-icon> {{user.address}}</p>\n            </div>\n            <!--  <div class="user_action" (click)="presentActionSheet(user,2,idx);" item-right>\n              <ion-icon item-right ios="ios-settings" md="md-settings"></ion-icon>\n            </div> -->\n          </ion-item>\n        </ion-item>\n\n      </ion-list>\n\n      <ion-infinite-scroll (ionInfinite)="fetchFollowerData($event)">\n        <ion-infinite-scroll-content loadingSpinner="bubbles">\n        </ion-infinite-scroll-content>\n      </ion-infinite-scroll>\n\n\n    </ion-list>\n\n  </div>\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\otherprofileconnections\otherprofileconnections.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], OtherprofileconnectionsPage);

//# sourceMappingURL=otherprofileconnections.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return OtherprofileeventsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_eventdetails_eventdetails__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__comment_comment__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_social_sharing__ = __webpack_require__(20);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Ionic pages and navigation.
 */
var OtherprofileeventsPage = (function () {
    function OtherprofileeventsPage(actionSheetCtrl, socialSharing, modalCtrl, remotService, events, navCtrl, navParams) {
        this.actionSheetCtrl = actionSheetCtrl;
        this.socialSharing = socialSharing;
        this.modalCtrl = modalCtrl;
        this.remotService = remotService;
    ...
    OtherprofileeventsPage.prototype.segmentChanged = function (event) {
        if (this.otherprofileeventstab == 'upcoming')
            this.initeventlist();
        else if (this.otherprofileeventstab == 'past')
            this.initeventlist();
    };
    OtherprofileeventsPage.prototype.initeventlist = function () {
        var _this = this;
        var DataToSend = {
        ...
        this.remotService.presentLoading();
        this.remotService.postData(DataToSend, 'fullEventsOne').subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (_this.otherprofileeventstab == 'past') {
                _this.eventlist = response.data.past;
            }
            else if (_this.otherprofileeventstab == 'upcoming') {
    ...
    OtherprofileeventsPage.prototype.eventDetails = function (event) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__pages_eventdetails_eventdetails__["a" /* EventdetailsPage */], { 'eventdetails': event });
    };
    OtherprofileeventsPage.prototype.likeThisitem = function (event) {
        var _this = this;
        var DataToSend = {
            user_id: window.localStorage['userid'],
    ...
    * show comments
    */
    OtherprofileeventsPage.prototype.showComments = function (event) {
        //console.log(event);
        var data = {
        ...
        var commentModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_4__comment_comment__["a" /* CommentPage */], { incidentitem: data });
        commentModal.onDidDismiss(function (data) {
            event.count = data.commentlength;
        });
        commentModal.present();
    };
    OtherprofileeventsPage.prototype.shareThisPost = function (event) {
    ...
    OtherprofileeventsPage.prototype.addtocalendarEvent = function (event) {
        var _this = this;
        var DataToSends = {
            userId: window.localStorage['userid'],
            eventId: event.id,
        ...
        this.remotService.postData(DataToSends, 'addToCalender').subscribe(function (response) {
            ...
            if (response.success == 1) {
                ...
                _this.remotService.presentToast('This event has been already added to your calender.');
            }
        }, function () {
            _this.remotService.dismissLoader();
            _this.remotService.presentToast('Error getting about details.');
    ...
    OtherprofileeventsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.events.publish('creoyou:hidemenu');
        this.navBar.backButtonClick = function () {
            _this.events.publish('creoyou:hidemenu');
    ...
    OtherprofileeventsPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
    return OtherprofileeventsPage;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], OtherprofileeventsPage.prototype, "navBar", void 0);
OtherprofileeventsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-otherprofileevents',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\otherprofileevents\otherprofileevents.html"*/'<ion-header class="creoyou-header">\n\n\n  <ion-navbar>\n    <ion-title>Events</ion-title>\n  </ion-navbar>\n\n  <ion-segment (ionChange)="segmentChanged($event)" [(ngModel)]="otherprofileeventstab">\n    <ion-segment-button value="upcoming">\n      Upcoming\n    </ion-segment-button>\n    <ion-segment-button value="past">\n      Past\n    </ion-segment-button>\n  </ion-segment>\n\n</ion-header>\n<ion-content>\n  <div [ngSwitch]="otherprofileeventstab">\n\n    <ion-list *ngSwitchCase="\'upcoming\'" class="individual">\n\n      <h2 class="no_result" *ngIf="eventlist==\'\'">You have no Upcoming Event</h2>\n      <ion-row *ngFor="let event of eventlist">\n        <ion-col class="EventContainer" *ngIf="otheruser_id==event.hosted_by">\n          <ion-list class="eventHeader" (click)="eventDetails(event)">\n            <ion-item>\n              <p class="EventTitle">{{event.name}}</p>\n              <p *ngIf="event.user_type==2"> by {{event.buisness_name}}</p>\n              <p *ngIf="event.user_type==1"> by {{event.fname}} {{event.lname}}</p>\n              <p class="EventUser"></p>\n              <p>{{event.start_date_time | date:\'mediumDate\'}} | {{event.start_date_time | date:\'shortTime\'}} - {{event.end_date_time\n                | date:\'mediumDate\'}} | {{event.end_date_time | date:\'shortTime\'}}</p>\n              <p>{{event.location}}</p>\n\n              <div class="post_action">\n                <!--   <ion-icon (tap)="eventaddtocalender(event)" ios="ios-more" md="md-more"></ion-icon> -->\n              </div>\n\n\n            </ion-item>\n\n          </ion-list>\n\n\n          <ion-list class="EventBody">\n            <ion-item>\n              <img src="{{base_url}}uploads/eventsImages/{{event.media_name}}" alt="Post Img" (click)="eventDetails(event)" />\n              <div class="EventDetails">\n                {{event.description | slice:0:110}}\n                <span *ngIf="event.description.length>110">.....</span>\n              </div>\n\n              <div class="EventDate">\n                <span>{{event.start_date_time | date:\'dd\'}}</span>\n                {{event.start_date_time | date:\'MMMM\'}}\n              </div>\n              <a (click)="addtocalendarEvent(event)">Add to calender</a>\n            </ion-item>\n\n\n          </ion-list>\n\n          <ion-row class="post_activity">\n            <ion-col col-4 [class.active]="event.likeActive>0">\n              <ion-icon ios="ios-heart" md="md-heart" (click)="likeThisitem(event)"></ion-icon>\n              <span>{{event.likes}}</span>\n            </ion-col>\n            <ion-col col-4>\n              <ion-icon ios="ios-text" md="md-text" (click)="showComments(event)"></ion-icon>\n              <span *ngIf="event.count==\'count\'"></span>\n              <span *ngIf="event.count!=\'count\'">{{event.count}}</span>\n            </ion-col>\n            <ion-col col-4>\n              <ion-icon ios="ios-share" md="md-share" (click)="shareThisPost(event);"></ion-icon>\n            </ion-col>\n          </ion-row>\n        </ion-col>\n      </ion-row>\n\n    </ion-list>\n\n\n    <ion-list *ngSwitchCase="\'past\'" class="individual">\n\n      <h2 class="no_result" *ngIf="eventlist==\'\'">You have no Past Event</h2>\n      <ion-row *ngFor="let event of eventlist">\n        <ion-col class="EventContainer" *ngIf="otheruser_id==event.hosted_by">\n          <ion-list class="eventHeader" (click)="eventDetails(event)">\n            <ion-item>\n              <p class="EventTitle">{{event.name}}</p>\n              <p *ngIf="event.user_type==2"> by {{event.buisness_name}}</p>\n              <p *ngIf="event.user_type==1"> by {{event.fname}} {{event.lname}}</p>\n              <p class="EventUser"></p>\n              <p>{{event.start_date_time | date:\'mediumDate\'}} | {{event.start_date_time | date:\'shortTime\'}} - {{event.end_date_time\n                | date:\'mediumDate\'}} | {{event.end_date_time | date:\'shortTime\'}}</p>\n              <p>{{event.location}}</p>\n            </ion-item>\n          </ion-list>\n\n          <ion-list class="EventBody">\n            <ion-item (click)="eventDetails(event)">\n              <img src="{{base_url}}uploads/eventsImages/{{event.media_name}}" alt="Post Img" />\n              <div class="EventDetails">\n                {{event.description | slice:0:110}}\n                <span *ngIf="event.description.length>110">.....</span>\n              </div>\n\n              <div class="EventDate">\n                <span>{{event.start_date_time | date:\'dd\'}}</span>\n                {{event.start_date_time | date:\'MMMM\'}}\n              </div>\n              <a (click)="addtocalendarEvent(event)">Add to calender</a>\n            </ion-item>\n\n          </ion-list>\n\n          <ion-row class="post_activity">\n            <ion-col col-4 [class.active]="event.likeActive>0">\n              <ion-icon ios="ios-heart" md="md-heart" (click)="likeThisitem(event)"></ion-icon>\n              <span>{{event.likes}}</span>\n            </ion-col>\n            <ion-col col-4>\n              <ion-icon ios="ios-text" md="md-text" (click)="showComments(event)"></ion-icon>\n              <span *ngIf="event.count==\'count\'"></span>\n              <span *ngIf="event.count!=\'count\'">{{event.count}}</span>\n            </ion-col>\n            <ion-col col-4>\n              <ion-icon ios="ios-share" md="md-share" (click)="shareThisPost(event);"></ion-icon>\n            </ion-col>\n          </ion-row>\n        </ion-col>\n      </ion-row>\n\n    </ion-list>\n\n  </div>\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\otherprofileevents\otherprofileevents.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_social_sharing__["a" /* SocialSharing */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */], __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], OtherprofileeventsPage);

//# sourceMappingURL=otherprofileevents.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return VisitedprofilePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_otherprofile_otherprofile__ = __webpack_require__(17);
 ...
 * Ionic pages and navigation.
 */
var VisitedprofilePage = (function () {
    function VisitedprofilePage(remotService, events, navCtrl, navParams) {
        this.remotService = remotService;
        this.events = events;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    VisitedprofilePage.prototype.initVisitedData = function () {
        var _this = this;
        var visitedData = {
            user_id: window.localStorage['userid'],
            token: window.localStorage['token']
        ...
        this.remotService.presentLoading();
        this.remotService.postData(visitedData, 'countView').subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (response.success == 1) {
                _this.visited = response.data.details;
    ...
    VisitedprofilePage.prototype.otherProfile = function (visit) {
        //console.log(visit);
        var data = {
            user_id: visit.id,
    ...
    VisitedprofilePage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.events.publish('creoyou:hidemenu');
        //over ridding back button
        this.navBar.backButtonClick = function () {
    ...
    return VisitedprofilePage;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], VisitedprofilePage.prototype, "navBar", void 0);
VisitedprofilePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-visitedprofile',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\visitedprofile\visitedprofile.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title>People Visited</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-list class="individual">\n\n    <ion-item *ngFor="let visit of visited;let idx=index;" padding-horizontal class="search_user search_user_individual" (click)="otherProfile(visit)">\n\n      <ion-avatar item-left>\n\n        <img *ngIf="visit.image!=null && visit.image!=\'\'" img-preloader="{{base_url}}uploads/profileImages/resizedImages/{{visit.image}}"\n          alt="avatar">\n        <img *ngIf="visit.image==null || visit.image==\'\'" img-preloader="assets/img/management.png" alt="avatar">\n      </ion-avatar>\n      <ion-item class="searcsh_right">\n\n        <p *ngIf="visit.fname || visit.lname && visit.user_type==1">{{visit.fname}} {{visit.lname}}</p>\n        <p *ngIf="visit.buisness_name && visit.user_type==2">{{visit.buisness_name}}</p>\n        <p class="user_deg" *ngIf="visit.cat_name">\n          {{visit.cat_name}}</p>\n        <p class="user_deg" *ngIf="visit.address">\n          <ion-icon name="home"></ion-icon> {{visit.address}}</p>\n\n      </ion-item>\n    </ion-item>\n\n    <ion-item *ngIf="connections?.length<=0 && shownone==1" class="no_result">\n      <h3> Sorry No visit Found... </h3>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\visitedprofile\visitedprofile.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], VisitedprofilePage);

//# sourceMappingURL=visitedprofile.js.map
 ...
 * Ionic pages and navigation.
 */
var ProfilecompletePage = (function () {
    function ProfilecompletePage(events, navCtrl, navParams) {
        this.events = events;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], ProfilecompletePage.prototype, "navBar", void 0);
ProfilecompletePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-profilecomplete',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\profilecomplete\profilecomplete.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title>Profile strength</ion-title>\n  </ion-navbar>\n\n</ion-header>\n<ion-content>\n\n  <ion-row class="content-background">\n    <ion-col col-12>\n      <img src="assets/img/Upgrade_logo.png" />\n      <span> Your Profile Strength depends on the following activities</span>\n    </ion-col>\n  </ion-row>\n\n  <ion-row class="profileStatus">\n    <ion-col col-12>\n      <h3>Profile Photo</h3>\n      <span>10%</span>\n    </ion-col>\n    <ion-col col-12 *ngIf="usertype==1">\n      <h3>Occupation+Location(Country,State and City)</h3>\n      <span>10%</span>\n    </ion-col>\n    <ion-col col-12 *ngIf="usertype==2">\n      <h3>Location(Country,State and City)</h3>\n      <span>10%</span>\n    </ion-col>\n\n    <ion-col col-12 *ngIf="usertype==1">\n      <h3>Abotu Me - 5 Or more fields filled excluding Specialization/ Skills</h3>\n      <span>10%</span>\n    </ion-col>\n    <ion-col col-12 *ngIf="usertype==2">\n      <h3> About Me - Company Overview </h3>\n      <span>10%</span>\n    </ion-col>\n\n    <ion-col col-12 *ngIf="usertype==1">\n      <h3>About Me - Specialization/ Skills summary</h3>\n      <span>10%</span>\n    </ion-col>\n\n    <ion-col col-12 *ngIf="usertype==2">\n      <h3>About - Specialization/ Skills</h3>\n      <span>10%</span>\n    </ion-col>\n\n    <ion-col col-12>\n      <h3> Portfolio – 10 + photo, video or audio uploads </h3>\n      <span>10%</span>\n    </ion-col>\n    <ion-col col-12>\n      <h3>Connections - Invitations sent to 50 or more non-creoyou members (Via email/yahoo/Google Contacts)</h3>\n      <span>20%</span>\n    </ion-col>\n    <ion-col col-12>\n      <h3>Connections - 50 or more</h3>\n      <span>10%</span>\n    </ion-col>\n\n    <ion-col col-12>\n      <h3>Following - 10 or more</h3>\n      <span>10%</span>\n    </ion-col>\n    <ion-col col-12>\n      <h3>Events - Posting and invite</h3>\n      <span>10%</span>\n    </ion-col>\n  </ion-row>\n\n\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\profilecomplete\profilecomplete.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], ProfilecompletePage);

//# sourceMappingURL=profilecomplete.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PremiumuserPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
 ...
 * Ionic pages and navigation.
 */
var PremiumuserPage = (function () {
    function PremiumuserPage(remotService, events, navCtrl, navParams) {
        this.remotService = remotService;
        this.events = events;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    PremiumuserPage.prototype.initgetPremiumUser = function () {
        var _this = this;
        var data = {
        ...
        this.remotService.presentLoading();
        this.remotService.postData(data, 'premiumDetails').subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (response.success == 1) {
                _this.membershipPlanData = response.data.membershipPlanData;
                _this.pointsAccumulationData = response.data.pointsAccumulationData;
                _this.usersCurrentPoints = response.data.usersCurrentPoints;
                _this.premiumuser = response.data.premiumUser;
    ...
    PremiumuserPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.events.publish('creoyou:hidemenu');
        this.navBar.backButtonClick = function () {
            _this.events.publish('creoyou:showmenu');
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], PremiumuserPage.prototype, "navBar", void 0);
PremiumuserPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-premiumuser',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\premiumuser\premiumuser.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title>Premium User</ion-title>\n  </ion-navbar>\n\n</ion-header>\n<ion-content>\n\n  <ion-row class="content-background">\n    <ion-col col-12>\n      <img src="assets/img/Upgrade_logo.png" />\n      <span>Welcome to the CreoYou Premium Membership Feature Plan</span>\n    </ion-col>\n  </ion-row>\n\n  <ion-row class="profileStatus">\n    <ion-col class="preDes" padding col-12>\n      <p>Take advantage of additional features on CreoYou. These features can either by purchased separately or through Reward\n        Points.\n        <!--  can either be\n        <b>Purchased</b> or\n        <b>Accumulated</b>by being actively involved on CreoYou. -->\n      </p>\n    </ion-col>\n\n    <ion-col class="benefits_" col-12>\n      <h1>Premium members enjoy tremendous benefits including</h1>\n\n      <p *ngFor="let item of membershipPlanData">\n        <ion-icon name="checkmark-circle-outline"></ion-icon>{{item.features}}</p>\n      <!-- <p>\n        <ion-icon name="checkmark-circle-outline"></ion-icon> Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>\n      <p>\n        <ion-icon name="checkmark-circle-outline"></ion-icon> Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p> -->\n\n      <span>An active CreoYou member ? Active members can earn CreoYou membership through Reward Points. Each activity on CreoYou\n        earns you reward points. Please see the chart below to see how you can accumulate reward points and get premium membership\n        for free. Alternatively, you can also purchase Premium Membership.\n      </span>\n    </ion-col>\n  </ion-row>\n\n\n\n\n  <ion-row>\n    <ion-col class="upgrade_table" col-12>\n      <div class="upgrade_table_head">\n        <h1>Upgrade for free using reward points </h1>\n        <p>Enjoy 1 month Premium Membership for 1000 reward points</p>\n      </div>\n      <span>Accumulate reward points through activity</span>\n    </ion-col>\n  </ion-row>\n\n  <ion-row class="upgrade_head">\n    <ion-col col-7>Activity Perfomed </ion-col>\n    <ion-col col-5>Reward Point</ion-col>\n  </ion-row>\n  <hr>\n  <ion-row class="upgrade_body" *ngFor="let item of pointsAccumulationData">\n    <ion-col col-7>{{item.accumulation_text}}</ion-col>\n    <ion-col col-5>{{item.accumulation_example}}</ion-col>\n  </ion-row>\n\n\n  <br/>\n\n\n  <ion-row>\n    <ion-col class="upgrade_table" col-12>\n      <div class="upgrade_table_head">\n        <h1>Purchase Premium Membership</h1>\n        <p>Enjoy one month Premium Membership for 1000 reward points</p>\n      </div>\n      <span>Select from various discounted offers</span>\n    </ion-col>\n  </ion-row>\n\n  <ion-row class="upgrade_head">\n    <ion-col col-7>Membership Team</ion-col>\n    <ion-col col-5>Cost</ion-col>\n  </ion-row>\n  <hr>\n  <ion-row class="upgrade_body">\n    <ion-col col-7>1 month</ion-col>\n    <ion-col col-5>Rs. 600/$10</ion-col>\n  </ion-row>\n  <ion-row class="upgrade_body">\n    <ion-col col-7>2 month</ion-col>\n    <ion-col col-5>Rs. 1000/$15</ion-col>\n  </ion-row>\n  <ion-row class="upgrade_body">\n    <ion-col col-7>3 month</ion-col>\n    <ion-col col-5>Rs. 1200/$20</ion-col>\n  </ion-row>\n  <ion-row class="upgrade_body">\n    <ion-col col-7>6 month</ion-col>\n    <ion-col col-5>Rs. 2000/$30</ion-col>\n  </ion-row>\n  <ion-row class="upgrade_body">\n    <ion-col col-7>12 month *Best Value*</ion-col>\n    <ion-col col-5>Rs. 3000/$50</ion-col>\n  </ion-row>\n\n\n  <ion-row class="upgrade_point" padding>\n    <h3>Please visit\n      <a href="https://creoyou.com/user/login">https://creoyou.com/</a> to purchase premium membership</h3>\n    <ion-col col-12>Your Current reward Point is\n      <b>{{usersCurrentPoints}}</b>\n    </ion-col>\n    <ion-col col-12 *ngIf="premiumuser==1">Currently you are enjoying Premium Membership till {{enddate}}</ion-col>\n  </ion-row>\n\n\n\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\premiumuser\premiumuser.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], PremiumuserPage);

//# sourceMappingURL=premiumuser.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ChangemobilenumberPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_reg_validator_reg_validator__ = __webpack_require__(53);
 ...
 * Ionic pages and navigation.
 */
var ChangemobilenumberPage = (function () {
    function ChangemobilenumberPage(remotService, viewCtrl, regValidator, formBuilder, navCtrl, navParams) {
        this.remotService = remotService;
        this.viewCtrl = viewCtrl;
        this.regValidator = regValidator;
        this.formBuilder = formBuilder;
    ...
    ChangemobilenumberPage.prototype.geturlcode = function () {
        var _this = this;
        var data = {
            userMobile: this.mobile_number
        };
        this.remotService.presentLoading();
        this.remotService.postData(data, 'getUrlCode').subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (response.success == 1) {
                _this.userUrlCode = response.data.userUrlCode;
            }
            else {
                _this.remotService.presentToast('Error saving data.');
            }
    ...
    ChangemobilenumberPage.prototype.changeMobileNumber = function (stepTwovalue) {
        var _this = this;
        if (this.FormRegistrationStepTwo.valid) {
            ...
            this.remotService.postData(codeData, 'reSendSms').subscribe(function (response) {
                ...
                if (response.success == 1) {
                    _this.remotService.dismissLoader();
                    _this.viewCtrl.dismiss({ mobileno: stepTwoform.mobileno });
                }
                else {
                    _this.remotService.presentToast('Error Sending Otp.');
                }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_reg_validator_reg_validator__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__ = __webpack_require__(5);
...
var LoginhelpPage = (function () {
    ...
    LoginhelpPage.prototype.gotoLoginpage = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__registration_registration__ = __webpack_require__(150);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WelcomePage = (function () {
    function WelcomePage(platform, viewCtrl, navCtrl, navParams, events) {
        this.viewCtrl = viewCtrl;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.events = events;
...
WelcomePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-welcome',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\welcome\welcome.html"*/'<ion-content class="ion-starter-content-background">\n\n    <ion-row class="homeslides">\n        <ion-slides pager autoplay="3000" centeredSlides="true">\n            <ion-slide class="first_slider">\n                <div class="col col-center slider-col">\n                    <img src="assets/img/logo.png" class="app_logo">\n                    <h3 class="pl_for">A Creative Platform for<br>Creative People</h3>\n                </div>    \n            </ion-slide>\n\n            <ion-slide>\n                <div class="col col-center slider-col">      	\n                    <h3 class="pl_for">Your Creative Profile</h3>\n                    <img src="assets/img/welcome2.png" class="slider_fraim">\n                </div>\n            </ion-slide>\n\n            <ion-slide>\n                <div class="col col-center slider-col">      	\n                    <h3 class="pl_for">Your creative portfolio</h3>\n                    <img src="assets/img/welcome3.png" class="slider_fraim">\n                </div>\n            </ion-slide>\n            <ion-slide>\n                <div class="col col-center slider-col">      	\n                    <h3 class="pl_for">Stay in touch with your  network </h3>\n                    <img src="assets/img/welcome4.png" class="slider_fraim">\n                </div>\n            </ion-slide>    \n            <ion-slide>\n                <div class="col col-center slider-col">      	\n                    <h3 class="pl_for">Find opportunities in your creative field</h3>\n                    <img src="assets/img/welcome5.png" class="slider_fraim">\n                </div>\n            </ion-slide>       \n        </ion-slides> \n    </ion-row>\n    \n\n</ion-content>\n\n<ion-footer>\n    <ion-row text-center class="welcome_accton">\n        <a class="joinNOw" (click)="signup()">JOIN NOW</a>\n        <a class="SignIn" (click)="login()">SIGN IN</a>\n    </ion-row>\n</ion-footer>\n\n'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\welcome\welcome.html"*/,
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_jobdetails_jobdetails__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__otherprofile_otherprofile__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var JobsPage = (function () {
    ...
    JobsPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
    return JobsPage;
}());
...
JobsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-jobs',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\jobs\jobs.html"*/'<ion-header class="creoyou-header">\n\n    <ion-navbar>\n        <ion-title>All Jobs</ion-title>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n    <ion-list class="individual">\n        <span *ngIf="addsData==\'\' && jobsData==\'\'">No job found.</span>\n\n        <ion-item *ngFor="let additem of addsData" padding-horizontal class="search_user search_user_individual job_add">\n            <ion-avatar item-left>\n                <img *ngIf="additem.image!=\'\' && additem.image!=null" src="{{base_url}}uploads/profileImages/resizedImages/{{additem.image}}">\n                <img *ngIf="additem.image==\'\' || additem.image==null" src="assets/img/management.png">\n            </ion-avatar>\n            <ion-item class="searcsh_right">\n                <p class="Company_name" (click)="OtherProfile(additem)"> {{additem.posted_by}} </p>\n                <div (click)="jobdetails(additem)">\n                    <p>\n                        <ion-icon name="briefcase"></ion-icon> {{additem.job_title}} </p>\n\n                    <p class="user_deg">Required Experience : {{additem.required_experience}}</p>\n                    <p class="user_deg">{{additem.address}}</p>\n                    <p class="user_deg" *ngIf="additem.second<60">{{additem.second }} Second ago | {{additem.name}}</p>\n                    <p class="user_deg" *ngIf="additem.minute<60 && additem.second>60">{{additem.minute }} Minute ago | {{additem.name}}</p>\n                    <p class="user_deg" *ngIf="additem.hour<24 && additem.minute>60">{{additem.hour}} hours ago | {{additem.name}}</p>\n                    <p class="user_deg" *ngIf="additem.hour>24 && additem.weeks<2">{{additem.days}} Days ago | {{additem.name}}</p>\n                    <p class="user_deg" *ngIf="additem.weeks>1">{{additem.weeks}} Weeks ago | {{additem.name}}</p>\n                </div>\n                <div class="user_action" item-right>\n                    <img src="assets/img/ad.png" alt="Image" />\n                </div>\n            </ion-item>\n        </ion-item>\n\n\n        <ion-item *ngFor="let job of jobsData" padding-horizontal class="search_user search_user_individual">\n            <ion-avatar item-left (click)="jobdetails(job)">\n                <img *ngIf="job.image!=\'\' && job.image!=null" src="{{base_url}}uploads/profileImages/resizedImages/{{job.image}}">\n                <img *ngIf="job.image==\'\' || job.image==null" src="assets/img/management.png">\n            </ion-avatar>\n            <ion-item class="searcsh_right">\n                <p class="Company_name" (click)="OtherProfile(job)">{{job.posted_by}}</p>\n                <div (click)="jobdetails(job)">\n                    <p>\n                        <ion-icon name="briefcase"></ion-icon> {{job.job_title}} </p>\n                    <p class="user_deg">Required Experience : {{job.required_experience}} </p>\n                    <p class="user_deg">{{job.address}}</p>\n                    <p class="user_deg" *ngIf="job.second<60">{{job.second }} Second ago | {{job.name}}</p>\n                    <p class="user_deg" *ngIf="job.minute<60 && job.second>60">{{job.minute }} Minute ago | {{job.name}}</p>\n                    <p class="user_deg" *ngIf="job.hour<24 && job.minute>60">{{job.hour}} hours ago | {{job.name}}</p>\n                    <p class="user_deg" *ngIf="job.hour>24 && job.weeks<2">{{job.days}} Days ago | {{job.name}}</p>\n                    <p class="user_deg" *ngIf="job.weeks>1">{{job.weeks}} Weeks ago | {{job.name}}</p>\n                </div>\n            </ion-item>\n        </ion-item>\n\n\n\n    </ion-list>\n\n\n    <!-- <ion-list>\n            <ion-item class="no_result">\n                 <h3> Sorry No Job Found... </h3> \n            </ion-item>\n          </ion-list> -->\n    <!-- <ion-infinite-scroll (ionInfinite)="fetchjobsData($event)">\n        <ion-infinite-scroll-content loadingSpinner="bubbles">\n        </ion-infinite-scroll-content>\n    </ion-infinite-scroll> -->\n\n\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\jobs\jobs.html"*/,
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_file_chooser__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_file_transfer__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_file_path__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__ = __webpack_require__(49);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var JobapplyPage = (function () {
    function JobapplyPage(file, filePath, remotService, transfer, fileChooser, viewCtrl, navCtrl, navParams) {
        this.file = file;
        this.filePath = filePath;
        this.remotService = remotService;
        this.transfer = transfer;
    ...
    JobapplyPage.prototype.chooseCV = function () {
        ...
        this.fileChooser.open().then(function (uri) {
            _this.filePath.resolveNativePath(uri).then(function (dt) {
                console.log(dt);
                _this.choseuri = dt;
                _this.fileSizeValidate(_this.choseuri);
                _this.fileExtValidate(_this.choseuri);
                _this.currentName = _this.choseuri.substr(_this.choseuri.lastIndexOf('/') + 1).replace(/ /g, '_');
                _this.currentName = _this.currentName.replace(/%20/g, '_');
                _this.currentName = _this.currentName.replace(/%/g, '_');
                _this.currentName = _this.currentName.replace(/[^a-zA-Z1-9.]/g, '');
    ...
    JobapplyPage.prototype.fileExtValidate = function (fdata) {
    ...
    JobapplyPage.prototype.fileSizeValidate = function (fdata) {
        var _this = this;
        this.maxSize = '2048';
        window.resolveLocalFileSystemURL(fdata, function (fileEntry) {
            fileEntry.getMetadata(function (metadata) {
                var fsize = metadata.size / 1024;
                if (fsize > _this.maxSize) {
                    _this.currentName = '';
                    _this.remotService.presentToast('Please upload a file with size less than: ' + 2 + "MB");
                    return false;
                }
                else {
                    return true;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_audio__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__commonmodal_commonmodal__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_image_picker__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_crop__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_camera__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_base64__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__comment_comment__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_social_sharing__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_otherprofile_otherprofile__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_photoview_photoview__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_audiodetails_audiodetails__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__videodetails_videodetails__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_eventdetails_eventdetails__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ionic_native_photo_viewer__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_advertisementdetails_advertisementdetails__ = __webpack_require__(273);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ionic_native_streaming_media__ = __webpack_require__(39);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FeedsPage = (function () {
    function FeedsPage(ngZone, streamingMedia, cd, photoViewer, navCtrl, actionSheetCtrl, _audioProvider, remotService, modalCtrl, events, imagepick, cropService, cameraservice, basesxfrservice, _DomSanitizer, socialSharing, alertCtrl) {
        this.ngZone = ngZone;
        this.streamingMedia = streamingMedia;
        this.cd = cd;
        this.photoViewer = photoViewer;
    ...
    FeedsPage.prototype.playThisTrack = function (event, track) {
        var _this = this;
        this.ngZone.run(function () {
            ...
            _this.currentTrack = track; // This should change the track no?
            _this.currentTrackNumber = (track.id);
            _this.arr.push(track.id);
            for (var i = 0; i < _this.arr.length; i++) {
                if (_this.currentTrackNumber != _this.arr[i]) {
                    _this._audioProvider.stop(_this.arr[i]);
                    var index = _this.arr.indexOf(_this.arr[i]);
                    if (index > -1) {
                        _this.arr.splice(index, 1);
                    }
                    for (var _i = 0, _a = _this.loopData; _i < _a.length; _i++) {
                        var g = _a[_i];
                        // item.incident_type==='Audio'
                        if (g.incident_type == 'Audio') {
                            for (var _b = 0, _c = g.myTracks; _b < _c.length; _b++) {
            ...
            _this._audioProvider.play(_this.currentTrackNumber);
            // this.videoPlayer.forEach((i: ElementRef) => {
            //   i.nativeElement.pause();
            // });
            if (_this.currentTrackNumber == (track.id)) {
                _this._audioProvider.pause(_this.currentTrackNumber);
            }
            // Gets the track number from the track id
    ...
    FeedsPage.prototype.playvideo = function (g) {
        var _this = this;
        this.ngZone.run(function () {
            _this._audioProvider.stop();
            for (var _i = 0, _a = _this.loopData; _i < _a.length; _i++) {
                var g_1 = _a[_i];
                // item.incident_type==='Audio'
                if (g_1.incident_type == 'Audio') {
            ...
            var url = _this.base_url + 'uploads/portfolioVideos/' + g;
            //console.log(this.videoPlayer);
            // this.videoPlayer.forEach((i: ElementRef) => {
            //   if (url == i.nativeElement.currentSrc) {
            //     i.nativeElement.play();
            ...
            _this.streamingMedia.playVideo(url, options);
            _this.cd.detectChanges();
        });
    };
    FeedsPage.prototype.initloopData = function () {
        var _this = this;
        this.addsData = [];
        this.loopData = [];
        var dataparams = {
        ...
        this.remotService.presentLoading();
        this.remotService.postData(dataparams, 'loop-data').subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (response.success == 1) {
                var responseLoopData = response.data.loopData;
                if (responseLoopData != null) {
                    responseLoopData.forEach(function (item, key, index) {
                        _this.modiFyitemasnecessary(item);
                        _this.loopData.push(item);
    ...
    FeedsPage.prototype.fetchMoreLoopdata = function (infiniteScroll) {
        var _this = this;
        /* this._audioProvider.pause(this.currentTrackNumber);
        this.videoPlayer.forEach((i: ElementRef) => {
          i.nativeElement.pause();
    ...
    * @param item
    */
    FeedsPage.prototype.modiFyitemasnecessary = function (item) {
        if (item.incident_type === 'Audio') {
            var audiosource = (item.audio_source != null && item.audio_source != '') ? item.audio_name : this.base_url + item.audio_name;
            item.myTracks = [{
                    src: audiosource,
    ...
    * show comments
    */
    FeedsPage.prototype.showComments = function (item) {
        var commentModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_10__comment_comment__["a" /* CommentPage */], { incidentitem: item });
        commentModal.onDidDismiss(function (data) {
            item.comments = data.commentlength;
        });
        commentModal.present();
    ...
    /**
      ...
      * @param items
      */
    FeedsPage.prototype.showextrataggedusers = function (items) {
        var taggeduswrs = [];
        items.tagged_to.forEach(function (itemElm, index) {
            if (index > 1)
                taggeduswrs.push(itemElm);
        });
        var commonModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_5__commonmodal_commonmodal__["a" /* CommonmodalPage */], {
            items: taggeduswrs,
     ...
     * @param item
     */
    FeedsPage.prototype.shareThisPost = function (item) {
        var type = '';
        if (item.incident_type == 'You Tube') {
            type = 'youtube';
        }
    ...
    FeedsPage.prototype.likeThisitem = function (item) {
        var _this = this;
        item.likeCheck = item.likeCheck == '' ? 'fillit' : '';
        var DataToSend = {
            user_id: window.localStorage['userid'],
    ...
    FeedsPage.prototype.getWholiked = function (item) {
        var _this = this;
        var DataToSend = {
        ...
        this.remotService.postData(DataToSend, 'seeLikes').subscribe(function (response) {
            ...
            if (response.success == 1) {
                ...
                var commonModal = _this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_5__commonmodal_commonmodal__["a" /* CommonmodalPage */], {
                    items: users,
    ...
    FeedsPage.prototype.presentActionSheet = function (item) {
        var _this = this;
        var actionSheet = this.actionSheetCtrl.create({
            buttons: [{
    ...
    FeedsPage.prototype.reportpost = function (item) {
    ...
    FeedsPage.prototype.hidepost = function (item) {
        var _this = this;
        var paramsobj = {
            user_id: window.localStorage['userid'],
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        _this.remotService.presentLoading();
                        _this.remotService.postData(paramsobj, 'unfollow-user-post').subscribe(function (response) {
                            _this.remotService.dismissLoader();
                            if (response.success == 1) {
                                _this.initloopData();
                            }
    ...
    FeedsPage.prototype.OtherFrofileView = function (item) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_12__pages_otherprofile_otherprofile__["a" /* OtherprofilePage */], { 'otheruserfrofiledata': item });
    };
    FeedsPage.prototype.addtocalendarEvent = function (item) {
        var _this = this;
        var DataToSends = {
            userId: window.localStorage['userid'],
            eventId: item.event_id,
    ...
    FeedsPage.prototype.zoomProfileImage = function (imageData) {
        var imagezoom = this.base_url + 'uploads/profileImages/' + imageData.incident_details;
        //console.log('zoom image', imageData);
        this.photoViewer.show(imagezoom, '', { share: false });
    };
    FeedsPage.prototype.zoomStatusImage = function (imageData) {
        var imagezoom = this.base_url + 'uploads/statusMedia/' + imageData.media_name;
        //console.log('zoom image', imageData);
        this.photoViewer.show(imagezoom, '', { share: false });
    };
    ...
    FeedsPage.prototype.gotoPhotoView = function (albumview, item) {
        var album = {
            id: albumview.album_id
        };
        //console.log(albumview);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_13__pages_photoview_photoview__["a" /* PhotoviewPage */], { "album": album, "img_id": albumview.id, 'touserid': item.user_id, "parentPage": this });
    };
    ...
    FeedsPage.prototype.ionViewWillLeave = function () {
        this._audioProvider.stop();
        this.remotService.dismissLoader();
    };
    FeedsPage.prototype.eventDetails = function (event) {
        var _this = this;
        if (event.data_type == 'ad') {
            ...
            this.remotService.postData(DataToSends, 'viewAdvertise').subscribe(function (response) {
                if (response.success == 1) {
                    _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_16__pages_eventdetails_eventdetails__["a" /* EventdetailsPage */], { 'eventdetails': event });
                }
                else {
                    _this.remotService.presentToast(response.message);
                }
            ...
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_16__pages_eventdetails_eventdetails__["a" /* EventdetailsPage */], { 'eventdetails': event });
        }
    };
    FeedsPage.prototype.audiodetails = function (track) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_14__pages_audiodetails_audiodetails__["a" /* AudiodetailsPage */], { audiodetails: track });
    };
    FeedsPage.prototype.videodetails = function (track) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_15__videodetails_videodetails__["a" /* VideodetailsPage */], { videodetails: track });
    };
    FeedsPage.prototype.addDetails = function (item) {
        var _this = this;
        var DataToSends = {
            token: window.localStorage['token'],
            user_id: window.localStorage['userid'],
        ...
        this.remotService.postData(DataToSends, 'viewAdvertise').subscribe(function (response) {
            if (response.success == 1) {
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_18__pages_advertisementdetails_advertisementdetails__["a" /* AdvertisementdetailsPage */], { adddetails: item });
            }
            else {
                _this.remotService.presentToast(response.message);
            }
...
FeedsPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"], __WEBPACK_IMPORTED_MODULE_19__ionic_native_streaming_media__["a" /* StreamingMedia */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectorRef"], __WEBPACK_IMPORTED_MODULE_17__ionic_native_photo_viewer__["a" /* PhotoViewer */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */],
        ...
        __WEBPACK_IMPORTED_MODULE_6__ionic_native_image_picker__["a" /* ImagePicker */], __WEBPACK_IMPORTED_MODULE_7__ionic_native_crop__["a" /* Crop */], __WEBPACK_IMPORTED_MODULE_8__ionic_native_camera__["a" /* Camera */],
        __WEBPACK_IMPORTED_MODULE_9__ionic_native_base64__["a" /* Base64 */], __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__["DomSanitizer"],
        __WEBPACK_IMPORTED_MODULE_11__ionic_native_social_sharing__["a" /* SocialSharing */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */]])
], FeedsPage);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AdvertisementdetailsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
 ...
 * Ionic pages and navigation.
 */
var AdvertisementdetailsPage = (function () {
    function AdvertisementdetailsPage(events, remotService, navCtrl, navParams) {
        this.events = events;
        this.remotService = remotService;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    AdvertisementdetailsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.events.publish('creoyou:hidemenu');
        this.navBar.backButtonClick = function () {
            _this.events.publish('creoyou:showmenu');
    ...
    AdvertisementdetailsPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
    return AdvertisementdetailsPage;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], AdvertisementdetailsPage.prototype, "navBar", void 0);
AdvertisementdetailsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-advertisementdetails',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\advertisementdetails\advertisementdetails.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title>Advertisement Details</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n\n  <ion-grid>\n\n    <ion-row>\n      <ion-col class="EventContainer">\n        <ion-list class="eventHeader">\n          <ion-item>\n            <ion-avatar item-left>\n              <img *ngIf="adddetails.image!=\'\' && adddetails.image!=null" src="{{base_url}}uploads/profileImages/resizedImages/{{adddetails?.image}}"\n                alt="avatar">\n              <img *ngIf="adddetails.image==\'\' || adddetails.image==null" src="assets/img/management.png" alt="avatar">\n            </ion-avatar>\n            <p class="EventTitle">{{adddetails.advertisement_text}}</p>\n            <p class="EventTitle" *ngIf="adddetails.users_full_name"> by {{adddetails.users_full_name}}</p>\n          </ion-item>\n        </ion-list>\n\n        <ion-list class="EventBody">\n          <ion-item *ngIf="adddetails.advertisement_type==\'image\'">\n            <img *ngIf="adddetails.ad_media" src="{{base_url}}uploads/portfolioImages/{{adddetails?.ad_media}}" alt="Post Img" />\n            <img *ngIf="adddetails.ad_media==\'\' || adddetails.ad_media==null" src="assets/img/management.png">\n            <div class="EventDetails">\n              {{adddetails.creation_date | date:\'mediumDate\'}} | {{adddetails.creation_date | date:\'shortTime\'}}\n            </div>\n            <div class="EventDetails">\n              <b>Title : </b> {{adddetails.advertisement_text}}\n            </div>\n            <div class="EventDetails">\n              <b>Description : </b> {{adddetails.advertisement_details}}\n            </div>\n          </ion-item>\n\n          <ion-item *ngIf="adddetails.advertisement_type==\'custom\'">\n            <img *ngIf="adddetails.ad_media" src="{{base_url}}uploads/customAdMedia/{{adddetails?.ad_media}}" alt="Post Img" />\n            <img *ngIf="adddetails.ad_media==\'\' || adddetails.ad_media==null" src="assets/img/management.png">\n            <div class="EventDetails">\n              {{adddetails.creation_date | date:\'mediumDate\'}} | {{adddetails.creation_date | date:\'shortTime\'}}\n            </div>\n            <div class="EventDetails">\n              <b>Title : </b> {{adddetails.advertisement_text}}\n            </div>\n            <div class="EventDetails">\n              <b>Description : </b> {{adddetails.advertisement_details}}\n            </div>\n          </ion-item>\n\n          <ion-item *ngIf="adddetails.advertisement_type==\'video\'">\n            <div class="EventDetails">\n              <b>Title : </b> {{adddetails.advertisement_text}}\n            </div>\n            <div class="EventDetails">\n              <b>Description : </b> {{adddetails.advertisement_details}}\n            </div>\n          </ion-item>\n        </ion-list>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\advertisementdetails\advertisementdetails.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], AdvertisementdetailsPage);

//# sourceMappingURL=advertisementdetails.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_notificationsdetails_notificationsdetails__ = __webpack_require__(275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_otherprofile_otherprofile__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var NotificationsPage = (function () {
    ...
    NotificationsPage.prototype.readnotification = function () {
        var reddata = {
            token: window.localStorage['token'],
            user_id: window.localStorage['userid']
        };
        this.remotService.postData(reddata, 'readNotification').subscribe(function (response) {
            /*   console.log(response);
         */
        }, function () {
    ...
    NotificationsPage.prototype.notificationDetails = function (notifications) {
        if (notifications.user_status == 4) {
            ...
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__pages_notificationsdetails_notificationsdetails__["a" /* NotificationsdetailsPage */], { 'notificationDetails': notifications });
        }
    };
...
NotificationsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-notifications',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\notifications\notifications.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title>Notification</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n  <ion-list>\n    <ion-item *ngIf="notiData==\'\'" class="no_result">\n      <h3>No notifications</h3>\n    </ion-item>\n\n    <ion-item *ngFor="let notifications of notiData;" class="" (click)="notificationDetails(notifications)">\n      <ion-avatar class="person-pic" item-left>\n        <img *ngIf="notifications.image!=\'\' && notifications.image!=null" src="{{base_url}}uploads/profileImages/{{notifications.image}}">\n        <img *ngIf="notifications.image==\'\' || notifications.image==null" src="assets/img/management.png">\n      </ion-avatar>\n      <ion-item class="notification_details">\n        <span>{{notifications.text}}</span>\n        <p>\n          <ion-icon ios="ios-time" md="md-time"> {{notifications.updation_date| amTimeAgo}}</ion-icon>\n        </p>\n      </ion-item>\n    </ion-item>\n\n\n  </ion-list>\n\n\n  <ion-infinite-scroll (ionInfinite)="fetchNotificationdata($event)">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\notifications\notifications.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_social_sharing__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__comment_comment__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_otherprofile_otherprofile__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__home_home__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_streaming_media__ = __webpack_require__(39);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NotificationsdetailsPage = (function () {
    function NotificationsdetailsPage(streamingMedia, modalCtrl, socialSharing, _audioProvider, remotService, navCtrl, navParams) {
        this.streamingMedia = streamingMedia;
        this.modalCtrl = modalCtrl;
        this.socialSharing = socialSharing;
        this._audioProvider = _audioProvider;
    ...
    NotificationsdetailsPage.prototype.initgetNotificationDetails = function () {
        var _this = this;
        var data = {
            token: window.localStorage['token'],
        ...
        console.log(data);
        this.remotService.presentLoading();
        this.remotService.postData(data, 'seenotificationDetails').subscribe(function (response) {
            _this.remotService.dismissLoader();
            //this.modiFyitemasnecessary(this.notdetails);
            _this.notdetails = response.data;
            console.log(_this.notdetails);
            response.data.forEach(function (item, key, index) {
                _this.modiFyitemasnecessary(item);
     ...
     * @param item
     */
    NotificationsdetailsPage.prototype.modiFyitemasnecessary = function (item) {
        if (item.incident_type === 'Audio') {
    ...
    NotificationsdetailsPage.prototype.ngAfterContentInit = function () {
        // get all tracks managed by AudioProvider so we can control playback via the API
        this.allTracks = this._audioProvider.tracks;
    };
    NotificationsdetailsPage.prototype.playSelectedTrack = function () {
        // use AudioProvider to control selected track 
        this._audioProvider.play(this.selectedTrack);
    };
    NotificationsdetailsPage.prototype.pauseSelectedTrack = function () {
        // use AudioProvider to control selected track 
        this._audioProvider.pause(this.selectedTrack);
    };
    NotificationsdetailsPage.prototype.onTrackFinished = function (track) {
     ...
     * @param item
     */
    NotificationsdetailsPage.prototype.shareThisPost = function (item) {
    ...
    * show comments
    */
    NotificationsdetailsPage.prototype.showComments = function (item) {
        var commentModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_5__comment_comment__["a" /* CommentPage */], { incidentitem: item });
        commentModal.onDidDismiss(function (data) {
            item.comments = data.commentlength;
        });
    ...
    NotificationsdetailsPage.prototype.likeThisitem = function (item) {
        var _this = this;
        item.likeCheck = item.likeCheck == '' ? 'fillit' : '';
        var DataToSend = {
            user_id: window.localStorage['userid'],
    ...
    NotificationsdetailsPage.prototype.playvideo = function (g) {
        var url = this.base_url + 'uploads/portfolioVideos/' + g;
        var options = {
            successCallback: function () {
            },
    ...
    NotificationsdetailsPage.prototype.ionViewDidLoad = function () {
        //console.log('ionViewDidLoad NotificationsdetailsPage');
    };
    NotificationsdetailsPage.prototype.OtherFrofileView = function (item) {
        // console.log(item);
        if (window.localStorage['userid'] == item.user_id) {
            this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_7__home_home__["a" /* HomePage */]);
        }
        else {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__pages_otherprofile_otherprofile__["a" /* OtherprofilePage */], { 'otheruserfrofiledata': item });
        }
    };
    NotificationsdetailsPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
NotificationsdetailsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-notificationsdetails',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\notificationsdetails\notificationsdetails.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title>Notification</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n  <br/>\n  <ion-row *ngFor="let item of notdetails">\n    <ion-col>\n      <div class="post_wrap">\n        <ion-list class="post_header">\n          <ion-item class="" padding-horizontal>\n            <ion-avatar class="person-pic" item-left>\n              <img *ngIf="item.image!=null && item.image!=\'\'" img-preloader="{{base_url}}uploads/profileImages/resizedImages/{{item.image}}"\n                alt="avatar">\n              <img *ngIf="item.image==null || item.image==\'\'" src="assets/img/management.png" alt="avatar">\n            </ion-avatar>\n\n            <ion-item class="status-check2" (click)="OtherFrofileView(item)">\n              <p class="Completed" text-center>\n\n                {{item.users_full_name}}\n                <span>{{item.incident_name}}</span>\n              </p>\n              <span>{{item.creation_date | amDateFormat:\'MMMM Do YYYY, h:mm:ss a\'}}</span>\n            </ion-item>\n            <!--  <div class="post_action">\n              <ion-icon (click)="presentActionSheet(item)" ios="ios-more" md="md-more"></ion-icon>\n            </div> -->\n          </ion-item>\n        </ion-list>\n\n        <ion-list class="post_body">\n          <ion-item *ngIf="item.incident_type===\'Status\'">\n            <p>{{item.user_status}}</p>\n\n            <img *ngIf="item.media_name!=\'\'" img-preloader="{{base_url}}uploads/statusMedia/{{item.media_name}}?t={{milliseconds}}" alt="Post Img"\n            />\n\n          </ion-item>\n          <ion-item *ngIf="item.incident_type===\'Event\'">\n            <p>{{item.user_status}}</p>\n\n            <img *ngIf="item.event_image!=\'\'" img-preloader="{{base_url}}uploads/eventsImages/{{item.event_image}}" alt="Post Img" />\n\n          </ion-item>\n\n          <ion-item *ngIf="item.incident_type===\'Profile\'">\n            <img img-preloader="{{base_url}}uploads/profileImages/{{item.incident_details}}" alt="Post Img" />\n            <!-- <img img-preloader="{{imgurl}}" alt="Post Img" /> -->\n\n          </ion-item>\n          <ion-item *ngIf="item.incident_type===\'Image\'">\n            <span *ngFor="let albumimage of item.image_details">\n              <img img-preloader="{{base_url}}uploads/portfolioImages/{{albumimage.image_name}}" alt="Post Img" />\n            </span>\n\n          </ion-item>\n          <ion-item *ngIf="item.incident_type===\'Audio\';">\n\n            <audio-track #audio *ngFor="let track of item.myTracks" [track]="track" (onFinish)="onTrackFinished($event)">\n              <ion-item>\n                <ion-thumbnail item-left>\n                  <img src="assets/img/audio_new.png">\n                  <audio-track-play dark [audioTrack]="audio">\n                    <ion-spinner></ion-spinner>\n                  </audio-track-play>\n                </ion-thumbnail>\n                <div item-content style="width:100%">\n                  <p>\n                    <strong>{{audio.title}}</strong> ⚬\n                    <em>{{audio.artist}}</em>\n                  </p>\n                  <audio-track-progress-bar dark duration progress [audioTrack]="audio" [ngStyle]="{visibility: audio.completed > 0 ? \'visible\' : \'show\'}"></audio-track-progress-bar>\n                </div>\n              </ion-item>\n            </audio-track>\n            <!-- {{item.test}}        -->\n          </ion-item>\n\n          <ion-item *ngIf="item.incident_type===\'You Tube\';">\n\n            <iframe width="100%" src="{{item.video_name}}" frameborder="0 " allowfullscreen></iframe>\n\n          </ion-item>\n\n          <ion-item *ngIf="item.incident_type===\'Video\'">\n\n\n            <div (tap)="playvideo(item.video_name)">\n              <img src="{{base_url}}uploads/portfolioVideoSnapshots/{{item.snapshot_name}}" />\n            </div>\n            <img (tap)="playvideo(item.video_name)" class="play_img" src="assets/img/play.svg" width="50px">\n\n            <!-- <video poster="{{base_url}}uploads/portfolioVideoSnapshots/{{item.snapshot_name}}" controls="controls" preload="metadata"\n              webkit-playsinline="webkit-playsinline" class="videoPlayer">\n              <source src="{{base_url}}uploads/portfolioVideos/{{item.video_name}}" type="video/mp4" />\n            </video> -->\n\n          </ion-item>\n\n          <ion-item *ngIf="item.tagged_to?.length > 0">\n            <p class="Post_tag">\n              With\n              <span *ngFor="let tagitem of item.tagged_to;let idx = index">\n                <span *ngIf="idx<2">{{tagitem.name}}\n                  <span *ngIf="idx<(item.tagged_to?.length-1)">,</span>\n                </span>\n              </span>\n              <span (click)="showextrataggedusers(item)" *ngIf="item.tagged_to?.length > 2">\n                <span class="andText"> and </span>\n                <span>{{item.tagged_to?.length-2}} other</span>\n              </span>\n\n            </p>\n          </ion-item>\n\n        </ion-list>\n\n        <ion-row class="post_activity">\n          <ion-col col-4 [class.active]="item.likeCheck!=\'\'">\n            <ion-icon (click)="likeThisitem(item)" ios="ios-heart" md="md-heart"></ion-icon>\n            <span (click)="getWholiked(item);">{{item.likes}}</span>\n          </ion-col>\n          <ion-col (click)="showComments(item)" col-4>\n            <ion-icon ios="ios-text" md="md-text"></ion-icon>\n            <span>{{item.comments}}</span>\n          </ion-col>\n          <ion-col (click)="shareThisPost(item);" col-4>\n            <ion-icon ios="ios-share" md="md-share"></ion-icon>\n          </ion-col>\n        </ion-row>\n      </div>\n    </ion-col>\n  </ion-row>\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\notificationsdetails\notificationsdetails.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_8__ionic_native_streaming_media__["a" /* StreamingMedia */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_social_sharing__["a" /* SocialSharing */], __WEBPACK_IMPORTED_MODULE_3_ionic_audio__["a" /* AudioProvider */], __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__search_search__ = __webpack_require__(156);
...
var SearchfilterPage = (function () {
    function SearchfilterPage(events, modalCtrl, formBuilder, remotService, navCtrl, navParams) {
        this.events = events;
        this.modalCtrl = modalCtrl;
        this.formBuilder = formBuilder;
        this.remotService = remotService;
    ...
    SearchfilterPage.prototype.advanceSearch = function () {
        ...
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__search_search__["a" /* SearchPage */], { adsearch: this.advsdata });
    };
    ...
    SearchfilterPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_photoupload_photoupload__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_albumview_albumview__ = __webpack_require__(141);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */])
], PhotosPage.prototype, "content", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_videoupload_videoupload__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_file_opener__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_file_path__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_file_transfer__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_file__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_social_sharing__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_videocomment_videocomment__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_videodetails_videodetails__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_streaming_media__ = __webpack_require__(39);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VideosPage = (function () {
    ...
    function VideosPage(streamingMedia, modalCtrl, socialSharing, alertCtrl, actionSheetCtrl, remotService, transfer, platform, file, fileOpener, _DomSanitizer, events, navCtrl, navParams, filePath) {
        this.streamingMedia = streamingMedia;
        this.modalCtrl = modalCtrl;
        this.socialSharing = socialSharing;
        this.alertCtrl = alertCtrl;
        ...
        var actionSheet = this.actionSheetCtrl.create({
            buttons: [{
                ...
                },
                {
                    ...
                    handler: function () {
                        if (vdo.is_ad == 1) {
                            _this.remotService.presentToast("You can't delete this video because you have advertised this video");
                        }
                        else {
                            var confirm_1 = _this.alertCtrl.create({
                                title: 'Remove Video',
    ...
    */
    VideosPage.prototype.showComments = function (vdo) {
        var commentModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_10__pages_videocomment_videocomment__["a" /* VideocommentPage */], { incidentitem: vdo });
        commentModal.onDidDismiss(function (data) {
    ...
    VideosPage.prototype.videodetails = function (vdo) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_11__pages_videodetails_videodetails__["a" /* VideodetailsPage */], { videodetails: vdo });
    };
    VideosPage.prototype.playvideo = function (g) {
        var url = this.base_url + 'uploads/portfolioVideos/' + g;
        //console.log(this.videoPlayer);
        // this.videoPlayer.forEach((i: ElementRef) => {
        //   if (url == i.nativeElement.currentSrc) {
    ...
    VideosPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
    return VideosPage;
}());
...
__decorate([
    ...
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["QueryList"])
], VideosPage.prototype, "iframe", void 0);
VideosPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_12__ionic_native_streaming_media__["a" /* StreamingMedia */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */], __WEBPACK_IMPORTED_MODULE_9__ionic_native_social_sharing__["a" /* SocialSharing */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_7__ionic_native_file_transfer__["a" /* FileTransfer */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* Platform */], __WEBPACK_IMPORTED_MODULE_8__ionic_native_file__["a" /* File */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_file_opener__["a" /* FileOpener */],
...
var VideouploadPage = (function () {
    function VideouploadPage(file, filePath, remotService, transfer, fileChooser, navCtrl, navParams) {
        this.file = file;
        this.filePath = filePath;
        this.remotService = remotService;
        this.transfer = transfer;
    ...
    VideouploadPage.prototype.fileExtValidate = function (fdata) {
    ...
    VideouploadPage.prototype.fileSizeValidate = function (fdata) {
        var _this = this;
        this.maxSize = '51200';
        window.resolveLocalFileSystemURL(fdata, function (fileEntry) {
            fileEntry.getMetadata(function (metadata) {
                ...
                if (fsize > _this.maxSize) {
                    _this.currentName = '';
                    _this.remotService.presentToast('Maximum file size exceed, This file size is: ' + 50 + "MB");
                    return false;
                }
                else {
                    return true;
    ...
    VideouploadPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_audio__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_audiupload_audiupload__ = __webpack_require__(281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_audiocomment_audiocomment__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_social_sharing__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_audiodetails_audiodetails__ = __webpack_require__(50);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AudiosPage = (function () {
    ...
    AudiosPage.prototype.playThisTrack = function (event, track) {
        if (track.select) {
            track.select = false;
        }
        else {
        ...
        var actionSheet = this.actionSheetCtrl.create({
            buttons: [{
                ...
                },
                {
                    ...
                    handler: function () {
                        if (ado.is_ad == 1) {
                            _this.remotService.presentToast("You can't delete this audio because you have advertised this audio");
                        }
                        else {
                            var confirm_1 = _this.alertCtrl.create({
                                title: 'Remove Audio',
    ...
    */
    ...
    AudiosPage.prototype.audiodetails = function (track) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__pages_audiodetails_audiodetails__["a" /* AudiodetailsPage */], { audiodetails: track });
    };
    AudiosPage.prototype.ionViewWillEnter = function () {
        this.content.resize();
    };
    AudiosPage.prototype.ionViewWillLeave = function () {
        this._audioProvider.stop();
        this.remotService.dismissLoader();
    };
    return AudiosPage;
...
var AudiuploadPage = (function () {
    function AudiuploadPage(file, filePath, transfer, fileChooser, remotService, navCtrl, navParams) {
        this.file = file;
        this.filePath = filePath;
        this.transfer = transfer;
        this.fileChooser = fileChooser;
    ...
    AudiuploadPage.prototype.fileExtValidate = function (fdata) {
        var validExt = ".mp3";
        var filePath = fdata;
        var getFileExt = filePath.substring(filePath.lastIndexOf('.') + 1).toLowerCase();
        var pos = validExt.indexOf(getFileExt);
    ...
    AudiuploadPage.prototype.fileSizeValidate = function (fdata) {
        var _this = this;
        this.maxSize = '20480';
        window.resolveLocalFileSystemURL(fdata, function (fileEntry) {
            fileEntry.getMetadata(function (metadata) {
    ...
    AudiuploadPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_eventcreate_eventcreate__ = __webpack_require__(283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_eventdetails_eventdetails__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__eventscalender_eventscalender__ = __webpack_require__(284);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__comment_comment__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_social_sharing__ = __webpack_require__(20);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EventlistPage = (function () {
    ...
    EventlistPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_base64__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_camera__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_image_picker__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_platform_browser__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_taguser_taguser__ = __webpack_require__(80);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EventcreatePage = (function () {
    ...
    EventcreatePage.prototype.ionViewDidEnter = function () {
        //console.log("Connection pages entered")
        this.content.resize();
    };
    /* For create event*/
    ...
    EventcreatePage.prototype.inviteConnection = function () {
        var _this = this;
        this.statustags = [];
        var connectionModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_7__pages_taguser_taguser__["a" /* TaguserPage */], { pagename: 'Invite your connections' });
        connectionModal.onDidDismiss(function (data) {
            if (data.tags.length > 0) {
                data.tags.forEach(function (item) {
    ...
    EventcreatePage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */])
], EventcreatePage.prototype, "content", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_parsonaledit_parsonaledit__ = __webpack_require__(286);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_in_app_browser__ = __webpack_require__(287);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */])
], PersonalPage.prototype, "content", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_reg_validator_reg_validator__ = __webpack_require__(53);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ParsonaleditPage = (function () {
    function ParsonaleditPage(alertCtrl, regValidator, formBuilder, navCtrl, navParams, events, actionSheetCtrl, remotService, modalCtrl) {
        ...
        this.FormRegistrationStepOne = formBuilder.group({
            email: ['', __WEBPACK_IMPORTED_MODULE_3__angular_forms__["g" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_3__angular_forms__["g" /* Validators */].maxLength(50), regValidator.mailFormat()]), regValidator.checkuniquevalueoffield('email', 1).bind(regValidator)]
        });
        this.FormRegistrationStepFour = formBuilder.group({
            username: ['', __WEBPACK_IMPORTED_MODULE_3__angular_forms__["g" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_3__angular_forms__["g" /* Validators */].minLength(1), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["g" /* Validators */].maxLength(50), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["g" /* Validators */].pattern('^$|^[A-Za-z0-9]+'), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["g" /* Validators */].required]), regValidator.checkuniquevalueoffield('username', 1).bind(regValidator)]
        });
        this.countryCode = regValidator.countryCodes;
    }
    ParsonaleditPage.prototype.ionViewDidEnter = function () {
        //console.log("Connection pages entered")
        this.content.resize();
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Content */])
], ParsonaleditPage.prototype, "content", void 0);
...
var PrivacyPage = (function () {
    ...
    PrivacyPage.prototype.initblockuser = function () {
        ...
        this.remotService.presentLoading();
        this.remotService.postData(datatosend, 'myBlockedUser').subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (response.success == 1) {
                ...
                _this.remotService.dismissLoader();
                _this.blockuser = response.data;
                _this.unblocked = response.message;
            }
        }, function () {
            _this.remotService.dismissLoader();
            _this.remotService.presentToast('Error!');
    ...
    PrivacyPage.prototype.initunflowuser = function () {
        ...
        this.remotService.postData(data, 'myUnfollowUser').subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (response.success == 1) {
    ...
    PrivacyPage.prototype.Seepost = function (bluser) {
        var _this = this;
        this.touserid = bluser.user_id;
        var DataToSend = {
            userId: window.localStorage['userid'],
        ...
        this.remotService.presentLoading();
        this.remotService.postData(DataToSend, 'removeUnfollow').subscribe(function (response) {
            _this.remotService.dismissLoader();
            if (response.success == 1) {
                _this.initunflowuser();
            }
            else {
                _this.remotService.dismissLoader();
            }
    ...
    PrivacyPage.prototype.segmentChanged = function (event) {
    ...
    PrivacyPage.prototype.acceptRequest = function (conn) {
        var _this = this;
        var token = window.localStorage['token'];
        var DataToSend = {
    ...
    PrivacyPage.prototype.initrejectedlist = function () {
        var _this = this;
        var DataToSend = {
            token: this.token,
            user_id: this.user_id
        ...
        this.remotService.presentLoading();
        this.remotService.postData(DataToSend, 'rejectedUserList').subscribe(function (response) {
            _this.remotService.dismissLoader();
            _this.rejectuser = response.data;
        }, function () {
            _this.remotService.dismissLoader();
            _this.remotService.presentToast('Error!');
        });
...
PrivacyPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-privacy',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\privacy\privacy.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title>Privacy</ion-title>\n  </ion-navbar>\n\n  <ion-segment (ionChange)="segmentChanged($event)" [(ngModel)]="privacy">\n    <ion-segment-button value="blocked">\n      Blocked\n    </ion-segment-button>\n    <ion-segment-button value="hiddenposts">\n      Hidden Posts\n    </ion-segment-button>\n\n    <ion-segment-button value="rejectedlist">\n      Rejected List\n    </ion-segment-button>\n\n  </ion-segment>\n\n\n\n</ion-header>\n\n\n<ion-content>\n\n\n  <div [ngSwitch]="privacy">\n\n    <ion-list *ngSwitchCase="\'blocked\'">\n\n      <ion-list *ngIf="unblocked">\n        <ion-item class="no_result">\n          <h3>No blocked users</h3>\n        </ion-item>\n      </ion-list>\n\n      <ion-list class="individual" *ngFor="let bluser of blockuser">\n\n\n        <ion-item padding-horizontal class="search_user search_user_individual" *ngIf="!unblocked">\n          <ion-avatar item-left>\n            <img *ngIf="bluser.image!=\'\' && bluser.image!=null" src="{{base_url}}uploads/profileImages/resizedImages/{{bluser.image}}"\n              alt="Image" />\n            <img *ngIf="bluser.image==\'\' || bluser.image==null" src="assets/img/management.png" alt="avatar">\n          </ion-avatar>\n          <ion-item class="searcsh_right">\n            <p *ngIf="bluser.user_type==1">{{bluser.fname}} {{bluser.lname}}</p>\n            <p *ngIf="bluser.user_type==2">{{bluser.buisness_name}}</p>\n            <p class="user_deg">\n              <ion-icon name="briefcase"></ion-icon> {{bluser.creativeField}}</p>\n            <div class="user_action" item-right>\n              <button ion-button block icon-right (click)="unblockUser(bluser)">Unblock</button>\n            </div>\n          </ion-item>\n        </ion-item>\n\n\n      </ion-list>\n\n    </ion-list>\n\n    <ion-list *ngSwitchCase="\'hiddenposts\'">\n\n      <ion-list *ngIf="unflowmsg">\n        <ion-item class="no_result">\n          <h3> {{unflowmsg}} </h3>\n        </ion-item>\n      </ion-list>\n\n      <ion-list class="individual" *ngFor="let unuser of unflowuser">\n        <ion-item padding-horizontal class="search_user search_user_individual">\n          <ion-avatar item-left>\n            <img *ngIf="unuser.image==\'\' && unuser.image==null" src="{{base_url}}uploads/profileImages/resizedImages/{{unuser.image}}"\n              alt="Image" />\n            <img *ngIf="unuser.image==\'\' || unuser.image==null" src="assets/img/management.png" alt="avatar">\n          </ion-avatar>\n          <ion-item class="searcsh_right">\n            <p *ngIf="unuser.user_full_name">{{unuser.user_full_name}}</p>\n\n            <p class="user_deg">\n              <ion-icon name="briefcase"></ion-icon> {{unuser.creativeField}}</p>\n            <div class="user_action" item-right>\n              <button ion-button block icon-right (click)="Seepost(unuser)">See Post</button>\n            </div>\n          </ion-item>\n        </ion-item>\n\n\n      </ion-list>\n\n    </ion-list>\n\n\n    <ion-list *ngSwitchCase="\'rejectedlist\'">\n\n      <ion-list *ngIf="rejectuser==\'\'">\n        <ion-item class="no_result">\n          <h3> No denied requests </h3>\n        </ion-item>\n      </ion-list>\n\n      <ion-list class="individual" *ngFor="let rejuser of rejectuser">\n        <ion-item padding-horizontal class="search_user search_user_individual">\n          <ion-avatar item-left>\n            <img *ngIf="rejuser.image==\'\' && rejuser.image==null" src="{{base_url}}uploads/profileImages/resizedImages/{{rejuser.image}}"\n              alt="Image" />\n            <img *ngIf="rejuser.image==\'\' || rejuser.image==null" src="assets/img/management.png" alt="avatar">\n          </ion-avatar>\n          <ion-item class="searcsh_right">\n            <p *ngIf="rejuser.users_full_name">{{rejuser.users_full_name}}</p>\n\n            <p class="user_deg">\n              <ion-icon name="briefcase"></ion-icon> {{rejuser.creativeField}}</p>\n            <div class="user_action" item-right>\n              <button (click)="acceptRequest(rejuser)" ion-button block icon-right>\n                <ion-icon name="person-add"></ion-icon> Accept\n              </button>\n            </div>\n          </ion-item>\n        </ion-item>\n\n\n      </ion-list>\n\n    </ion-list>\n\n  </div>\n\n\n\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\privacy\privacy.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], PrivacyPage);
...
var CommentPage = (function () {
    ...
    CommentPage.prototype.seecomment = function () {
        var _this = this;
        var commentsParams = {
    ...
    CommentPage.prototype.OtherFrofileView = function (data) {
        if (data.user_status == 4) {
            this.remotService.presentToast('Your are not allowed to view that profile.');
        }
        else if (this.currentuserid == data.user_id) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__registration_registration__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_storage__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__loginhelp_loginhelp__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_google_plus__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_facebook__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__socialreg_socialreg__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_onesignal__ = __webpack_require__(154);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginPage = (function () {
    function LoginPage(menu, navCtrl, navParams, formBuilder, remotService, modalCtrl, storage, events, fb, googlePlus, oneSignal, platform) {
        var _this = this;
        this.menu = menu;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        ...
        this.loginForm = formBuilder.group({
            username: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].minLength(1), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].maxLength(50), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required])],
            password: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].minLength(8), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].maxLength(20), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required])]
        });
        ...
        if (platform.is('cordova')) {
            this.oneSignal.getIds().then(function (ids) {
                ...
                _this.onesignalplayerid = ids.userId;
                _this.onesignaltoken = ids.pushToken;
            });
        }
    }
        ...
        this.googlePlus.login({
            ...
            _this.remotService.postData(googleparams, 'googlelogin').subscribe(function (response) {
                ...
                if (response.success == 1) {
                    ...
                    // fire event in app.component to show the header
                    _this.events.publish('user:loggedin');
                    _this.remotService.presentToast('login successful');
                }
                else {
        ...
        this.remotService.postData(loginParams, 'userLogin').subscribe(function (response) {
            ...
            if (response.success == 1) {
                ...
                if (response.message === 'You are not a verified user') {
                    ...
                    _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__registration_registration__["a" /* RegistrationPage */], { verifyotp: data });
                }
            }
        }, function () {
            _this.remotService.dismissLoader();
...
LoginPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* MenuController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */],
        ...
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_8__ionic_native_facebook__["a" /* Facebook */], __WEBPACK_IMPORTED_MODULE_7__ionic_native_google_plus__["a" /* GooglePlus */], __WEBPACK_IMPORTED_MODULE_10__ionic_native_onesignal__["a" /* OneSignal */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* Platform */]])
], LoginPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ionic_audio__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_angular_svg_round_progressbar__ = __webpack_require__(490);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_image_picker__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_crop__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_camera__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_base64__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_file_chooser__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_file_transfer__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_ionic2_calendar__ = __webpack_require__(491);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__ionic_native_photo_viewer__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ionic_native_diagnostic__ = __webpack_require__(256);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ionic_native_android_permissions__ = __webpack_require__(257);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__ionic_native_contacts__ = __webpack_require__(258);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__app_component__ = __webpack_require__(502);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_home_home__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_login_login__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_welcome_welcome__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_categories_categories__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_registration_registration__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_aboutme_aboutme__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_jobs_jobs__ = __webpack_require__(270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_portfolio_portfolio__ = __webpack_require__(260);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_connections_connections__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_settings_settings__ = __webpack_require__(513);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_feeds_feeds__ = __webpack_require__(272);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_eventscalender_eventscalender__ = __webpack_require__(284);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_notifications_notifications__ = __webpack_require__(274);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_messages_messages__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__pages_search_search__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__pages_photos_photos__ = __webpack_require__(277);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__pages_videos_videos__ = __webpack_require__(278);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__pages_audios_audios__ = __webpack_require__(280);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__pages_loginhelp_loginhelp__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__pages_commonmodal_commonmodal__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__pages_socialreg_socialreg__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__pages_taguser_taguser__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__pages_comment_comment__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__pages_follow_follow__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__pages_invitefriend_invitefriend__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__pages_messagedetails_messagedetails__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__pages_newmessage_newmessage__ = __webpack_require__(261);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__pages_aboutedit_aboutedit__ = __webpack_require__(259);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__pages_photoupload_photoupload__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__pages_photoview_photoview__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__pages_videoupload_videoupload__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__pages_videocomment_videocomment__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_52__pages_audiocomment_audiocomment__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53__pages_audiupload_audiupload__ = __webpack_require__(281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_54__pages_albumview_albumview__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_55__pages_eventcreate_eventcreate__ = __webpack_require__(283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_56__pages_eventlist_eventlist__ = __webpack_require__(282);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_57__pages_eventdetails_eventdetails__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_58__pages_searchfilter_searchfilter__ = __webpack_require__(276);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_59__pages_jobdetails_jobdetails__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_60__pages_jobapply_jobapply__ = __webpack_require__(271);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_61__pages_personal_personal__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_62__pages_parsonaledit_parsonaledit__ = __webpack_require__(286);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_63__pages_privacy_privacy__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_64__pages_otherprofile_otherprofile__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_65__pages_notificationsettings_notificationsettings__ = __webpack_require__(289);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_66__pages_otherprofileconnections_otherprofileconnections__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_67__pages_otherprofileevents_otherprofileevents__ = __webpack_require__(263);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_68__pages_notificationsdetails_notificationsdetails__ = __webpack_require__(275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_69__pages_visitedprofile_visitedprofile__ = __webpack_require__(264);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_70__pages_profilecomplete_profilecomplete__ = __webpack_require__(265);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_71__pages_premiumuser_premiumuser__ = __webpack_require__(266);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_72__pages_videodetails_videodetails__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_73__pages_audiodetails_audiodetails__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_74__pages_advertisementdetails_advertisementdetails__ = __webpack_require__(273);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_75__pages_photodetails_photodetails__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_76__pages_changemobilenumber_changemobilenumber__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_77__providers_auth_service_auth_service__ = __webpack_require__(514);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_78__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_79__providers_reg_validator_reg_validator__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_80__providers_global_global__ = __webpack_require__(515);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_81__ionic_storage__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_82__ionic_native_onesignal__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_83__ionic_native_google_plus__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_84__ionic_native_facebook__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_85__directives_textgrow_textgrow__ = __webpack_require__(516);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_86__ionic_native_social_sharing__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_87_ionic_tags_input__ = __webpack_require__(517);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_88__ionic_native_in_app_browser__ = __webpack_require__(287);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_89__directives_img_preload_img_preload__ = __webpack_require__(519);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_90_angular2_moment__ = __webpack_require__(520);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_90_angular2_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_90_angular2_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_91__ionic_native_file_opener__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_92__ionic_native_file_path__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_93__ionic_native_file__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_94__ionic_native_streaming_media__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_95__ionic_native_network__ = __webpack_require__(290);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_96__ionic_native_device__ = __webpack_require__(291);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_19__app_component__["a" /* CreoYouApp */],
            ...
            __WEBPACK_IMPORTED_MODULE_23__pages_categories_categories__["a" /* CategoriesPage */],
            __WEBPACK_IMPORTED_MODULE_25__pages_aboutme_aboutme__["a" /* AboutmePage */],
            ...
            __WEBPACK_IMPORTED_MODULE_28__pages_connections_connections__["a" /* ConnectionsPage */],
            __WEBPACK_IMPORTED_MODULE_27__pages_portfolio_portfolio__["a" /* PortfolioPage */],
            __WEBPACK_IMPORTED_MODULE_30__pages_feeds_feeds__["a" /* FeedsPage */],
            __WEBPACK_IMPORTED_MODULE_32__pages_notifications_notifications__["a" /* NotificationsPage */],
            __WEBPACK_IMPORTED_MODULE_31__pages_eventscalender_eventscalender__["a" /* EventscalenderPage */],
            ...
            __WEBPACK_IMPORTED_MODULE_35__pages_photos_photos__["a" /* PhotosPage */],
            __WEBPACK_IMPORTED_MODULE_36__pages_videos_videos__["a" /* VideosPage */],
            __WEBPACK_IMPORTED_MODULE_37__pages_audios_audios__["a" /* AudiosPage */],
            __WEBPACK_IMPORTED_MODULE_38__pages_loginhelp_loginhelp__["a" /* LoginhelpPage */],
            __WEBPACK_IMPORTED_MODULE_39__pages_commonmodal_commonmodal__["a" /* CommonmodalPage */],
            __WEBPACK_IMPORTED_MODULE_40__pages_socialreg_socialreg__["a" /* SocialregPage */],
            __WEBPACK_IMPORTED_MODULE_41__pages_taguser_taguser__["a" /* TaguserPage */],
            __WEBPACK_IMPORTED_MODULE_42__pages_comment_comment__["a" /* CommentPage */],
            __WEBPACK_IMPORTED_MODULE_85__directives_textgrow_textgrow__["a" /* TextgrowDirective */],
            __WEBPACK_IMPORTED_MODULE_43__pages_follow_follow__["a" /* FollowPage */],
            __WEBPACK_IMPORTED_MODULE_44__pages_invitefriend_invitefriend__["a" /* InvitefriendPage */],
            __WEBPACK_IMPORTED_MODULE_45__pages_messagedetails_messagedetails__["a" /* MessagedetailsPage */],
            __WEBPACK_IMPORTED_MODULE_46__pages_newmessage_newmessage__["a" /* NewmessagePage */],
            __WEBPACK_IMPORTED_MODULE_47__pages_aboutedit_aboutedit__["a" /* AbouteditPage */],
            __WEBPACK_IMPORTED_MODULE_48__pages_photoupload_photoupload__["a" /* PhotouploadPage */],
            __WEBPACK_IMPORTED_MODULE_49__pages_photoview_photoview__["a" /* PhotoviewPage */],
            __WEBPACK_IMPORTED_MODULE_50__pages_videoupload_videoupload__["a" /* VideouploadPage */],
            __WEBPACK_IMPORTED_MODULE_51__pages_videocomment_videocomment__["a" /* VideocommentPage */],
            __WEBPACK_IMPORTED_MODULE_52__pages_audiocomment_audiocomment__["a" /* AudiocommentPage */],
            __WEBPACK_IMPORTED_MODULE_53__pages_audiupload_audiupload__["a" /* AudiuploadPage */],
            __WEBPACK_IMPORTED_MODULE_54__pages_albumview_albumview__["a" /* AlbumviewPage */],
            __WEBPACK_IMPORTED_MODULE_55__pages_eventcreate_eventcreate__["a" /* EventcreatePage */],
            __WEBPACK_IMPORTED_MODULE_56__pages_eventlist_eventlist__["a" /* EventlistPage */],
            __WEBPACK_IMPORTED_MODULE_57__pages_eventdetails_eventdetails__["a" /* EventdetailsPage */],
            __WEBPACK_IMPORTED_MODULE_58__pages_searchfilter_searchfilter__["a" /* SearchfilterPage */],
            __WEBPACK_IMPORTED_MODULE_59__pages_jobdetails_jobdetails__["a" /* JobdetailsPage */],
            __WEBPACK_IMPORTED_MODULE_60__pages_jobapply_jobapply__["a" /* JobapplyPage */],
            __WEBPACK_IMPORTED_MODULE_61__pages_personal_personal__["a" /* PersonalPage */],
            __WEBPACK_IMPORTED_MODULE_62__pages_parsonaledit_parsonaledit__["a" /* ParsonaleditPage */],
            __WEBPACK_IMPORTED_MODULE_63__pages_privacy_privacy__["a" /* PrivacyPage */],
            __WEBPACK_IMPORTED_MODULE_64__pages_otherprofile_otherprofile__["a" /* OtherprofilePage */],
            __WEBPACK_IMPORTED_MODULE_65__pages_notificationsettings_notificationsettings__["a" /* NotificationsettingsPage */],
            __WEBPACK_IMPORTED_MODULE_89__directives_img_preload_img_preload__["a" /* ImgPreloadDirective */],
            __WEBPACK_IMPORTED_MODULE_66__pages_otherprofileconnections_otherprofileconnections__["a" /* OtherprofileconnectionsPage */],
            __WEBPACK_IMPORTED_MODULE_67__pages_otherprofileevents_otherprofileevents__["a" /* OtherprofileeventsPage */],
            __WEBPACK_IMPORTED_MODULE_68__pages_notificationsdetails_notificationsdetails__["a" /* NotificationsdetailsPage */],
            __WEBPACK_IMPORTED_MODULE_69__pages_visitedprofile_visitedprofile__["a" /* VisitedprofilePage */],
            __WEBPACK_IMPORTED_MODULE_70__pages_profilecomplete_profilecomplete__["a" /* ProfilecompletePage */],
            __WEBPACK_IMPORTED_MODULE_71__pages_premiumuser_premiumuser__["a" /* PremiumuserPage */],
            __WEBPACK_IMPORTED_MODULE_72__pages_videodetails_videodetails__["a" /* VideodetailsPage */],
            __WEBPACK_IMPORTED_MODULE_73__pages_audiodetails_audiodetails__["a" /* AudiodetailsPage */],
            __WEBPACK_IMPORTED_MODULE_74__pages_advertisementdetails_advertisementdetails__["a" /* AdvertisementdetailsPage */],
            __WEBPACK_IMPORTED_MODULE_75__pages_photodetails_photodetails__["a" /* PhotodetailsPage */],
            __WEBPACK_IMPORTED_MODULE_76__pages_changemobilenumber_changemobilenumber__["a" /* ChangemobilenumberPage */]
        ],
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_19__app_component__["a" /* CreoYouApp */], {}, {
                links: [
                    ...
                    { loadChildren: '../pages/advertisementdetails/advertisementdetails.module#AdvertisementdetailsPageModule', name: 'AdvertisementdetailsPage', segment: 'advertisementdetails', priority: 'low', defaultHistory: [] },
                    ...
                    { loadChildren: '../pages/audiodetails/audiodetails.module#AudiodetailsPageModule', name: 'AudiodetailsPage', segment: 'audiodetails', priority: 'low', defaultHistory: [] },
                    ...
                    { loadChildren: '../pages/changemobilenumber/changemobilenumber.module#ChangemobilenumberPageModule', name: 'ChangemobilenumberPage', segment: 'changemobilenumber', priority: 'low', defaultHistory: [] },
                    ...
                    { loadChildren: '../pages/otherprofileconnections/otherprofileconnections.module#OtherprofileconnectionsPageModule', name: 'OtherprofileconnectionsPage', segment: 'otherprofileconnections', priority: 'low', defaultHistory: [] },
                    { loadChildren: '../pages/otherprofileevents/otherprofileevents.module#OtherprofileeventsPageModule', name: 'OtherprofileeventsPage', segment: 'otherprofileevents', priority: 'low', defaultHistory: [] },
                    ...
                    { loadChildren: '../pages/photodetails/photodetails.module#PhotodetailsPageModule', name: 'PhotodetailsPage', segment: 'photodetails', priority: 'low', defaultHistory: [] },
                    ...
                    { loadChildren: '../pages/premiumuser/premiumuser.module#PremiumuserPageModule', name: 'PremiumuserPage', segment: 'premiumuser', priority: 'low', defaultHistory: [] },
                    { loadChildren: '../pages/privacy/privacy.module#PrivacyPageModule', name: 'PrivacyPage', segment: 'privacy', priority: 'low', defaultHistory: [] },
                    { loadChildren: '../pages/profilecomplete/profilecomplete.module#ProfilecompletePageModule', name: 'ProfilecompletePage', segment: 'profilecomplete', priority: 'low', defaultHistory: [] },
                    ...
                    { loadChildren: '../pages/visitedprofile/visitedprofile.module#VisitedprofilePageModule', name: 'VisitedprofilePage', segment: 'visitedprofile', priority: 'low', defaultHistory: [] },
                    { loadChildren: '../pages/welcome/welcome.module#WelcomePageModule', name: 'WelcomePage', segment: 'welcome', priority: 'low', defaultHistory: [] }
                ]
            }),
            __WEBPACK_IMPORTED_MODULE_81__ionic_storage__["a" /* IonicStorageModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_90_angular2_moment__["MomentModule"],
            __WEBPACK_IMPORTED_MODULE_87_ionic_tags_input__["a" /* IonTagsInputModule */],
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_78__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_79__providers_reg_validator_reg_validator__["a" /* RegValidatorProvider */],
            __WEBPACK_IMPORTED_MODULE_80__providers_global_global__["a" /* GlobalProvider */],
            __WEBPACK_IMPORTED_MODULE_82__ionic_native_onesignal__["a" /* OneSignal */],
            __WEBPACK_IMPORTED_MODULE_83__ionic_native_google_plus__["a" /* GooglePlus */],
            ...
            __WEBPACK_IMPORTED_MODULE_86__ionic_native_social_sharing__["a" /* SocialSharing */],
            ...
            __WEBPACK_IMPORTED_MODULE_91__ionic_native_file_opener__["a" /* FileOpener */],
            __WEBPACK_IMPORTED_MODULE_92__ionic_native_file_path__["a" /* FilePath */],
            __WEBPACK_IMPORTED_MODULE_94__ionic_native_streaming_media__["a" /* StreamingMedia */],
            __WEBPACK_IMPORTED_MODULE_93__ionic_native_file__["a" /* File */],
            __WEBPACK_IMPORTED_MODULE_88__ionic_native_in_app_browser__["a" /* InAppBrowser */],
            ...
            __WEBPACK_IMPORTED_MODULE_18__ionic_native_contacts__["a" /* Contacts */],
            __WEBPACK_IMPORTED_MODULE_95__ionic_native_network__["a" /* Network */],
            __WEBPACK_IMPORTED_MODULE_96__ionic_native_device__["a" /* Device */]
        ]
    })
], AppModule);
...
var RemoteServiceProvider = (function () {
    ...
    RemoteServiceProvider.prototype.getCategories = function (term, usertype) {
        if (usertype === void 0) { usertype = 1; }
        var url = this.API_URL + "user-category/" + usertype + "?term=" + term;
    ...
    RemoteServiceProvider.prototype.presentLoading = function () {
...
RemoteServiceProvider = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["i" /* LoadingController */],
        __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["r" /* ToastController */], __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AudiodetailsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
 ...
 * Ionic pages and navigation.
 */
var AudiodetailsPage = (function () {
    function AudiodetailsPage(remotService, events, navCtrl, navParams) {
        this.remotService = remotService;
        this.events = events;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    AudiodetailsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.events.publish('creoyou:hidemenu');
        this.navBar.backButtonClick = function () {
            _this.events.publish('creoyou:hidemenu');
    ...
    AudiodetailsPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], AudiodetailsPage.prototype, "navBar", void 0);
AudiodetailsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-audiodetails',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\audiodetails\audiodetails.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title>Audio Details</ion-title>\n\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <ion-grid>\n\n    <ion-row>\n      <ion-col class="EventContainer">\n        <ion-list class="EventBody">\n          <ion-item>\n            <div class="EventDetails">\n              <b>Audio Title : </b>\n              <span *ngIf="audiodetails?.audio_title">{{audiodetails?.audio_title}}</span>\n\n              <span *ngIf="audiodetails?.audio_title==\'\'">No title</span>\n            </div>\n            <div class="EventDetails">\n              <b>Description : </b>\n              <span *ngIf="audiodetails?.audio_description">{{audiodetails?.audio_description}}</span>\n              <span *ngIf="audiodetails?.audio_description==\'\'">No description</span>\n            </div>\n          </ion-item>\n        </ion-list>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\audiodetails\audiodetails.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], AudiodetailsPage);

//# sourceMappingURL=audiodetails.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_welcome_welcome__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_aboutme_aboutme__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_jobs_jobs__ = __webpack_require__(270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_connections_connections__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_follow_follow__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_feeds_feeds__ = __webpack_require__(272);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_notifications_notifications__ = __webpack_require__(274);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_messages_messages__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_search_search__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_photos_photos__ = __webpack_require__(277);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_videos_videos__ = __webpack_require__(278);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_audios_audios__ = __webpack_require__(280);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_eventlist_eventlist__ = __webpack_require__(282);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_personal_personal__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_privacy_privacy__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_notificationsettings_notificationsettings__ = __webpack_require__(289);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__ionic_native_onesignal__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__ionic_native_diagnostic__ = __webpack_require__(256);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__ionic_native_android_permissions__ = __webpack_require__(257);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__ionic_native_contacts__ = __webpack_require__(258);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__ionic_native_network__ = __webpack_require__(290);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__ionic_native_device__ = __webpack_require__(291);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CreoYouApp = (function () {
    function CreoYouApp(device, network, contacts, androidPermissions, diagnostic, menu, alertCtrl, app, platform, statusBar, splashScreen, oneSignal, events, remoteService) {
        var _this = this;
        this.device = device;
        ...
        this.firstNavItems = [{ name: 'Home', link: __WEBPACK_IMPORTED_MODULE_4__pages_home_home__["a" /* HomePage */], 'icon': 'home' }, { name: 'About', link: __WEBPACK_IMPORTED_MODULE_7__pages_aboutme_aboutme__["a" /* AboutmePage */] }, { name: 'Jobs', link: __WEBPACK_IMPORTED_MODULE_8__pages_jobs_jobs__["a" /* JobsPage */] }];
        this.secondNavItems = [{ name: 'Photos', link: __WEBPACK_IMPORTED_MODULE_15__pages_photos_photos__["a" /* PhotosPage */] }, { name: 'Videos', link: __WEBPACK_IMPORTED_MODULE_16__pages_videos_videos__["a" /* VideosPage */] }, { name: 'Audios', link: __WEBPACK_IMPORTED_MODULE_17__pages_audios_audios__["a" /* AudiosPage */] }];
        this.frthNavItems = [{ name: 'Upcoming', link: __WEBPACK_IMPORTED_MODULE_18__pages_eventlist_eventlist__["a" /* EventlistPage */] }, { name: 'Past', link: __WEBPACK_IMPORTED_MODULE_18__pages_eventlist_eventlist__["a" /* EventlistPage */] }];
        this.thirdNavItems = [{ name: 'Connections', link: __WEBPACK_IMPORTED_MODULE_9__pages_connections_connections__["a" /* ConnectionsPage */] }, { name: 'Following', link: __WEBPACK_IMPORTED_MODULE_10__pages_follow_follow__["a" /* FollowPage */] }];
        this.fifthNavItems = [{ name: 'Personal', link: __WEBPACK_IMPORTED_MODULE_19__pages_personal_personal__["a" /* PersonalPage */] }, { name: 'Privacy', link: __WEBPACK_IMPORTED_MODULE_20__pages_privacy_privacy__["a" /* PrivacyPage */] },
            { name: 'Notification', link: __WEBPACK_IMPORTED_MODULE_21__pages_notificationsettings_notificationsettings__["a" /* NotificationsettingsPage */] }];
        this.showmenu = false;
        this.userimage = '';
        ...
        platform.ready().then(function () {
            ...
            events.subscribe('creoyou:loopmenu', function () {
                _this.topMenuItems = [{ 'icon': 'md-search', 'link': __WEBPACK_IMPORTED_MODULE_14__pages_search_search__["a" /* SearchPage */] },
                    { 'icon': 'home', 'link': __WEBPACK_IMPORTED_MODULE_4__pages_home_home__["a" /* HomePage */] },
                    { 'icon': 'md-person-add', 'link': __WEBPACK_IMPORTED_MODULE_9__pages_connections_connections__["a" /* ConnectionsPage */] },
                    { 'icon': 'notifications', 'link': __WEBPACK_IMPORTED_MODULE_12__pages_notifications_notifications__["a" /* NotificationsPage */] },
                    { 'icon': 'md-chatbubbles', 'link': __WEBPACK_IMPORTED_MODULE_13__pages_messages_messages__["a" /* MessagesPage */] }];
            });
            ...
            _this.topMenuItems = [{ 'icon': 'md-search', 'link': __WEBPACK_IMPORTED_MODULE_14__pages_search_search__["a" /* SearchPage */] },
                { 'icon': 'loop', 'link': __WEBPACK_IMPORTED_MODULE_11__pages_feeds_feeds__["a" /* FeedsPage */] },
                { 'icon': 'md-person-add', 'link': __WEBPACK_IMPORTED_MODULE_9__pages_connections_connections__["a" /* ConnectionsPage */] },
                { 'icon': 'notifications', 'link': __WEBPACK_IMPORTED_MODULE_12__pages_notifications_notifications__["a" /* NotificationsPage */] },
                { 'icon': 'md-chatbubbles', 'link': __WEBPACK_IMPORTED_MODULE_13__pages_messages_messages__["a" /* MessagesPage */] }];
            //this.username = window.localStorage['username'];
            if (platform.is('cordova')) {
                _this.oneSignal.startInit('7d221876-1bdf-4171-a878-29006dc6152c', '855303232010');
                ...
                _this.oneSignal.handleNotificationOpened().subscribe(function (jsonData) {
                    ...
                    if (typeof userid == "undefined") {
                        ...
                        var locationPath = __WEBPACK_IMPORTED_MODULE_5__pages_login_login__["a" /* LoginPage */];
                        if (response.action == 'friendrequest') {
                            locationPath = __WEBPACK_IMPORTED_MODULE_9__pages_connections_connections__["a" /* ConnectionsPage */];
                            _this.nav.push(locationPath, { 'location': response.action });
                        }
                        else if (response.action == 'Event') {
                            locationPath = __WEBPACK_IMPORTED_MODULE_18__pages_eventlist_eventlist__["a" /* EventlistPage */];
                            _this.nav.push(locationPath);
                        }
                        else if (response.action == 'messages') {
                            locationPath = __WEBPACK_IMPORTED_MODULE_13__pages_messages_messages__["a" /* MessagesPage */];
                            _this.nav.push(locationPath);
                        }
                        else {
                            locationPath = __WEBPACK_IMPORTED_MODULE_12__pages_notifications_notifications__["a" /* NotificationsPage */];
                            _this.nav.push(locationPath);
                        }
                    }
    ...
    CreoYouApp.prototype.ionViewDidLoad = function () {
    ...
    CreoYouApp.prototype.logOutUser = function () {
        ...
        this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_6__pages_welcome_welcome__["a" /* WelcomePage */], { closeapp: true });
    };
    CreoYouApp.prototype.checkonlineofline = function () {
        var _this = this;
        // network connect or disconnect
        var connectSubscription = this.network.onConnect().subscribe(function () {
        });
        var disconnectSubscription = this.network.onDisconnect().subscribe(function () {
            var error = 'Network disconnected';
            //show toast message mp
            _this.remoteService.presentToast(error);
        });
    };
    CreoYouApp.prototype.gotoPage = function (item) {
        /*  if (item.icon == 'home') { */
        this.topMenuItems = [{ 'icon': 'md-search', 'link': __WEBPACK_IMPORTED_MODULE_14__pages_search_search__["a" /* SearchPage */] },
            { 'icon': 'loop', 'link': __WEBPACK_IMPORTED_MODULE_11__pages_feeds_feeds__["a" /* FeedsPage */] },
            { 'icon': 'md-person-add', 'link': __WEBPACK_IMPORTED_MODULE_9__pages_connections_connections__["a" /* ConnectionsPage */] },
            { 'icon': 'notifications', 'link': __WEBPACK_IMPORTED_MODULE_12__pages_notifications_notifications__["a" /* NotificationsPage */] },
            { 'icon': 'md-chatbubbles', 'link': __WEBPACK_IMPORTED_MODULE_13__pages_messages_messages__["a" /* MessagesPage */] }];
    ...
    CreoYouApp.prototype.menuClosed = function () {
        this.events.publish('menu:closed', '');
    };
    CreoYouApp.prototype.menuOpened = function () {
        //this.content.scrollToTop();
...
var VideodetailsPage = (function () {
    function VideodetailsPage(events, navCtrl, navParams) {
        this.events = events;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], VideodetailsPage.prototype, "navBar", void 0);
VideodetailsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-videodetails',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\videodetails\videodetails.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title>Video Details</ion-title>\n\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <ion-grid>\n\n    <ion-row>\n      <ion-col class="EventContainer">\n        <ion-list class="EventBody">\n          <ion-item>\n            <div class="EventDetails" *ngIf="videodetails.data_type!=\'ad\'">\n              <b>Video Title : </b>\n              <span *ngIf="videodetails.video_title">{{videodetails.video_title}}</span>\n              <span *ngIf="videodetails.video_title==\'\'">No title</span>\n            </div>\n\n            <div class="EventDetails" *ngIf="videodetails.data_type==\'ad\'">\n              <b>Video Title : </b>\n              <span *ngIf="videodetails.advertisement_text">{{videodetails.advertisement_text}}</span>\n              <span *ngIf="videodetails.advertisement_text==\'\'">No title</span>\n            </div>\n\n\n            <div class="EventDetails" *ngIf="videodetails.data_type!=\'ad\'">\n              <b>Description : </b>\n              <span *ngIf="videodetails.video_description">{{videodetails.video_description}}</span>\n              <span *ngIf="videodetails.video_description==\'\'">No description</span>\n            </div>\n\n            <div class="EventDetails" *ngIf="videodetails.data_type==\'ad\'">\n              <b>Description : </b>\n              <span *ngIf="videodetails.advertisement_details">{{videodetails.advertisement_details}}</span>\n              <span *ngIf="videodetails.advertisement_details==\'\'">No description</span>\n            </div>\n          </ion-item>\n        </ion-list>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\videodetails\videodetails.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], VideodetailsPage);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ImgPreloadDirective; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var ImgPreloadDirective = (function () {
    function ImgPreloadDirective(events) {
        this.events = events;
        // Set an input so the directive can set a default image.
        this.defaultImage = 'assets/img/loader.gif';
    }
    //ngOnInit is needed to access the @inputs() variables. these aren't available on constructor()
    ImgPreloadDirective.prototype.ngOnInit = function () {
        var _this = this;
    ...
    return ImgPreloadDirective;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('img-preloader'),
    __metadata("design:type", String)
], ImgPreloadDirective.prototype, "targetSource", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", String)
], ImgPreloadDirective.prototype, "defaultImage", void 0);
ImgPreloadDirective = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Directive"])({
...
var EventdetailsPage = (function () {
    function EventdetailsPage(events, remotService, actionSheetCtrl, navCtrl, navParams) {
        this.events = events;
        this.remotService = remotService;
        this.actionSheetCtrl = actionSheetCtrl;
        this.navCtrl = navCtrl;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], EventdetailsPage.prototype, "navBar", void 0);
EventdetailsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-eventdetails',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\eventdetails\eventdetails.html"*/'<ion-header class="creoyou-header">\n\n  <ion-navbar>\n    <ion-title>Event Details</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n\n  <ion-grid>\n\n    <ion-row>\n      <ion-col class="EventContainer">\n        <ion-list class="eventHeader">\n          <ion-item *ngIf="eventdetails.data_type!=\'ad\'">\n            <ion-avatar item-left>\n              <img *ngIf="eventdetails.image!=\'\' && eventdetails.image!=null" src="{{base_url}}uploads/profileImages/resizedImages/{{eventdetails.image}}"\n                alt="avatar">\n              <img *ngIf="eventdetails.image==\'\' || eventdetails.image==null" src="assets/img/management.png" alt="avatar">\n            </ion-avatar>\n            <p class="EventTitle">{{eventdetails.name}}</p>\n            <p class="EventTitle" *ngIf="eventdetails.fname"> by {{eventdetails.fname}} {{eventdetails.lname}}</p>\n            <p class="EventTitle" *ngIf="eventdetails.buisness_name"> by {{eventdetails.buisness_name}}</p>\n            <p class="EventTitle" *ngIf="eventdetails.users_full_name"> by {{eventdetails.users_full_name}}</p>\n          </ion-item>\n\n\n          <ion-item *ngIf="eventdetails.data_type==\'ad\'">\n            <ion-avatar item-left>\n              <img *ngIf="eventdetails.image!=\'\' && eventdetails.image!=null" src="{{base_url}}uploads/profileImages/resizedImages/{{eventdetails.image}}"\n                alt="avatar">\n              <img *ngIf="eventdetails.image==\'\' || eventdetails.image==null" src="assets/img/management.png" alt="avatar">\n            </ion-avatar>\n            <p class="EventTitle">{{eventdetails.advertisement_text}}</p>\n            <p class="EventTitle" *ngIf="eventdetails.users_full_name"> by {{eventdetails.users_full_name}}</p>\n\n          </ion-item>\n        </ion-list>\n\n\n\n\n        <ion-list class="EventBody">\n          <ion-item *ngIf="eventdetails.data_type!=\'ad\'">\n            <img *ngIf="eventdetails.event_image" src="{{base_url}}uploads/eventsImages/{{eventdetails?.event_image}}" alt="Post Img"\n            />\n            <img *ngIf="eventdetails.event_image==\'\' || eventdetails.event_image==null" src="assets/img/management.png" alt="avatar">\n            <div class="EventDetails">\n              <b>Event Date : </b>{{eventdetails.start_date_time | date:\'mediumDate\'}} | {{eventdetails.start_date_time | date:\'shortTime\'}}\n              - {{eventdetails.end_date_time | date:\'mediumDate\'}} | {{eventdetails.end_date_time | date:\'shortTime\'}}\n            </div>\n            <div class="EventDetails">\n              <b>Event Title : </b> {{eventdetails.name}}\n            </div>\n            <div class="EventDetails">\n              <b>Event Location : </b> {{eventdetails.location}}\n            </div>\n            <div class="EventDetails">\n              <b>Description : </b> {{eventdetails.description}}\n            </div>\n\n            <div class="EventDate">\n              <span>{{eventdetails.start_date_time | date:\'dd\'}}</span>\n              {{eventdetails.start_date_time | date:\'MMMM\'}}\n            </div>\n          </ion-item>\n\n\n          <ion-item *ngIf="eventdetails.data_type==\'ad\'">\n            <img *ngIf="eventdetails.ad_media" src="{{base_url}}uploads/eventsImages/{{eventdetails?.ad_media}}" alt="Post Img" />\n            <img *ngIf="eventdetails.ad_media==\'\' || eventdetails.event_image==null" src="assets/img/management.png" alt="avatar">\n            <div class="EventDetails">\n              <b>Event Date : </b>{{eventdetails.start_date_time | date:\'mediumDate\'}} | {{eventdetails.start_date_time | date:\'shortTime\'}}\n              - {{eventdetails.end_date_time | date:\'mediumDate\'}} | {{eventdetails.end_date_time | date:\'shortTime\'}}\n            </div>\n            <div class="EventDetails">\n              <b>Event Title : </b> {{eventdetails.advertisement_text}}\n            </div>\n            <div class="EventDetails">\n              <b>Event Location : </b> {{eventdetails.location}}\n            </div>\n            <div class="EventDetails">\n              <b>Description : </b> {{eventdetails.advertisement_details}}\n            </div>\n\n            <div class="EventDate">\n              <span>{{eventdetails.start_date_time | date:\'dd\'}}</span>\n              {{eventdetails.start_date_time | date:\'MMMM\'}}\n            </div>\n          </ion-item>\n        </ion-list>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\eventdetails\eventdetails.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], EventdetailsPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_debounceTime__ = __webpack_require__(139);
            ...
            return new Promise(function (resolve) {
                if (control.valueChanges) {
                    control.valueChanges.debounceTime(700).subscribe(function (search) {
                        _this.remotService.checkifemailExist({
                            user_type: user_type, field_name: field_name,
                            field_value: control.value
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_audio__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__commonmodal_commonmodal__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_image_picker__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_crop__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_camera__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_base64__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__angular_platform_browser__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__taguser_taguser__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__comment_comment__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_social_sharing__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_connections_connections__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_follow_follow__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_visitedprofile_visitedprofile__ = __webpack_require__(264);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_profilecomplete_profilecomplete__ = __webpack_require__(265);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_premiumuser_premiumuser__ = __webpack_require__(266);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_photoview_photoview__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_eventdetails_eventdetails__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ionic_native_photo_viewer__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_audiodetails_audiodetails__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__videodetails_videodetails__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__login_login__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__ionic_native_streaming_media__ = __webpack_require__(39);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = (function () {
    function HomePage(streamingMedia, photoViewer, app, platform, viewCtrl, alertCtrl, navCtrl, actionSheetCtrl, _audioProvider, remotService, modalCtrl, events, imagepick, cropService, cameraservice, basesxfrservice, _DomSanitizer, socialSharing) {
        this.streamingMedia = streamingMedia;
        this.photoViewer = photoViewer;
        this.app = app;
        this.platform = platform;
    ...
    HomePage.prototype.zoomProfileImage = function (imageData) {
        var imagezoom = this.base_url + 'uploads/profileImages/' + imageData.incident_details;
        //console.log('zoom image', imageData);
        this.photoViewer.show(imagezoom, '', { share: false });
    };
    HomePage.prototype.zoomStatusImage = function (imageData) {
        var imagezoom = this.base_url + 'uploads/statusMedia/' + imageData.media_name;
        //console.log('zoom image', imageData);
        this.photoViewer.show(imagezoom, '', { share: false });
    };
    HomePage.prototype.initdatLoad = function () {
        ...
        this.remotService.postData(homeparam, 'homePage').subscribe(function (response) {
            ...
            if (response.success == 1) {
                ...
                console.log('image downloaded', _this.progileinfo);
                var targetbgimage = _this.base_url + "uploads/backgroundImages/" + _this.progileinfo.background_image;
                var downloadingbgImage = new Image(); // create image object
                downloadingbgImage.onload = function () {
                    _this.bgimage = targetbgimage; //do the switch 😀
                };
                // Assign the src to that of some_remote_image_url. Since its an Image Object the
                // on assignment from this.targetSource download would start immediately in the background
                // and trigger the onload()
        ...
        this.remotService.postData(dataHomeParams, 'home-data').subscribe(function (response) {
            ...
            if (response.success == 1) {
                ...
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_23__login_login__["a" /* LoginPage */], { closeapp: true });
                window.localStorage.clear();
                _this.showmenu = false;
            }
            else {
    ...
    HomePage.prototype.playThisTrack = function (event, track) {
        if (track.select) {
            track.select = false;
        }
        else {
    ...
    HomePage.prototype.playvideo = function (g) {
        this._audioProvider.stop();
        for (var _i = 0, _a = this.homeData; _i < _a.length; _i++) {
            var g_1 = _a[_i];
            // item.incident_type==='Audio'
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        // console.log(DataToSend);
                                        _this.remotService.presentLoading();
                                        _this.remotService.postData(DataToSend, 'deleteAction').subscribe(function (response) {
                                            _this.remotService.dismissLoader();
                                            var index = _this.homeData.indexOf(item);
                                            _this.homeData.splice(index, 1);
                                            _this.remotService.presentToast('You have successfully deleted the post');
                                        }, function () {
                                            _this.remotService.dismissLoader();
                                            _this.remotService.presentToast('Error!');
                                        });
    ...
    HomePage.prototype.statusPrivacy = function () {
        ...
        var actionSheet = this.actionSheetCtrl.create({
            buttons: [{
                    ...
                    handler: function () {
                        _this.statusprivacy = 1;
                        _this.statusprivacytext = 'Public';
                    }
                },
                {
                    text: 'Connection only',
                    handler: function () {
                        _this.statusprivacy = 2;
                        _this.statusprivacytext = 'Connection only';
                    }
                },
                {
                    text: 'Connection & Followers',
                    handler: function () {
                        _this.statusprivacy = 3;
                        _this.statusprivacytext = 'Connection & Followers';
                    }
                },
                {
                    text: 'Only me',
                    handler: function () {
                        _this.statusprivacy = 4;
                        _this.statusprivacytext = 'Only me';
                    }
                }
            ]
        });
    ...
    HomePage.prototype.showUsersTotag = function () {
        var _this = this;
        this.statustags = [];
        var connectionModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_10__taguser_taguser__["a" /* TaguserPage */], { pagename: 'Tag Your Friend' });
        connectionModal.onDidDismiss(function (data) {
            if (data.tags.length > 0) {
                data.tags.forEach(function (item) {
    ...
    HomePage.prototype.VisitedProfile = function (progileinfo) {
        if (progileinfo.premium_user == 0) {
            this.remotService.presentToast(' Upgrade to Premium to see who has viewed your profile ');
        }
        else {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_15__pages_visitedprofile_visitedprofile__["a" /* VisitedprofilePage */]);
        }
    };
    HomePage.prototype.gotoPhotoView = function (albumview) {
        var album = {
            id: albumview.album_id
        };
        // console.log(albumview);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_18__pages_photoview_photoview__["a" /* PhotoviewPage */], { "album": album, "img_id": albumview.id, 'touserid': window.localStorage['userid'], "parentPage": this });
    };
    HomePage.prototype.profilecomplite = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_16__pages_profilecomplete_profilecomplete__["a" /* ProfilecompletePage */], { usertype: window.localStorage['usertype'] });
    };
    HomePage.prototype.getPremiumDetails = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_17__pages_premiumuser_premiumuser__["a" /* PremiumuserPage */]);
    };
    HomePage.prototype.addtocalendarEvent = function (item) {
        var _this = this;
        var DataToSends = {
            userId: window.localStorage['userid'],
            eventId: item.event_id,
    ...
    HomePage.prototype.eventDetails = function (event) {
        // console.log(event);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_19__pages_eventdetails_eventdetails__["a" /* EventdetailsPage */], { 'eventdetails': event });
    };
    HomePage.prototype.audiodetails = function (track) {
        // console.log(track);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_21__pages_audiodetails_audiodetails__["a" /* AudiodetailsPage */], { audiodetails: track });
    };
    HomePage.prototype.videodetails = function (track) {
        //console.log(track);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_22__videodetails_videodetails__["a" /* VideodetailsPage */], { videodetails: track });
    };
...
HomePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-home',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\home\home.html"*/'<ion-content>\n\n  <ion-row class="User_profile_wrap" [style.backgroundImage]="\'url(\'+bgimage+\')\'">\n\n\n    <ion-col col-5>\n      <div class="prifile_image_box ">\n        <div class="prifile_image">\n          <img *ngIf="progileinfo.image!=null && progileinfo.image!=\'\'" src="{{base_url}}uploads/profileImages/resizedImages/{{progileinfo.image}}">\n          <img *ngIf="progileinfo.image==null || progileinfo.image==\'\'" src="assets/img/management.png">\n        </div>\n        <div *ngIf="progileinfo.premium_user==1" class="premimum_badge"></div>\n        <button class="attach_photo" (click)="addImage()">\n          <i class="material-icons">mode_edit</i>\n        </button>\n      </div>\n    </ion-col>\n    <ion-col col-7 class="user_title">\n      <div *ngIf="progileinfo.user_type==1">\n        <h2>\n          {{progileinfo.fname}} {{progileinfo.lname}}\n        </h2>\n        <p *ngIf="progileinfo.cat_name !== \'\'">{{progileinfo.cat_name}}</p>\n        <p *ngIf="progileinfo.country !== \'\' && progileinfo.country !== null">\n          {{progileinfo.country}}, {{progileinfo.state}}\n        </p>\n        <p *ngIf="progileinfo.premium_user==1">\n          {{progileinfo.website_url | slice:0:20}}\n          <span *ngIf="progileinfo.website_url.length>20">...</span>\n        </p>\n      </div>\n\n      <div *ngIf="progileinfo.user_type==2">\n        <h2>\n          {{progileinfo.buisness_name}}\n        </h2>\n        <p *ngIf="progileinfo.cat_name !== \'\'">{{progileinfo.cat_name}}</p>\n        <p *ngIf="progileinfo.country !== \'\' && progileinfo.country !== null">\n          {{progileinfo.country}}, {{progileinfo.state}}, {{progileinfo.city}}\n        </p>\n        <p *ngIf="progileinfo.user_address  && progileinfo.premium_user==1">\n          {{progileinfo.user_address | slice: 0: 20}}\n          <span *ngIf="progileinfo.user_address.length>20">...</span>\n        </p>\n\n        <p *ngIf="progileinfo.premium_user==1">\n          {{progileinfo.website_url | slice: 0: 20}}\n          <span *ngIf="progileinfo.website_url.length>20">...</span>\n        </p>\n      </div>\n    </ion-col>\n\n\n\n    <ion-col col-6>\n      <div class="Progress">\n        <h2>Profile Strength</h2>\n        <div class="progress_container">\n          <p>{{progileinfo.completenessPercentage}}%</p>\n          <round-progress [current]="progileinfo.completenessPercentage" [max]="maxprogress" [color]="\'#006400\'" [background]="\'#ffffff\'"\n            [radius]="20" [stroke]="5" [semicircle]="false" [rounded]="true" [clockwise]="true" [responsive]="true" [duration]="800"\n            [animation]="\'easeInOutQuart\'" [animationDelay]="0" (click)="profilecomplite()"></round-progress>\n        </div>\n        <button class="" (click)="profilecomplite()">Complete Profile</button>\n      </div>\n    </ion-col>\n    <ion-col col-6>\n      <div class="Upgrade">\n        <h2>Upgrade</h2>\n        <img img-preloader="assets/img/Upgrade_logo.png" class="update_logo" (click)="getPremiumDetails()">\n        <button class="" (click)="VisitedProfile(progileinfo)">{{progileinfo.countViews}} People Visited Your Profile</button>\n      </div>\n    </ion-col>\n\n  </ion-row>\n\n\n  <ion-row class="followers">\n    <ion-col col-6>\n      <h1 (click)="gotoPage(\'follow\')" class="follow_count_normal_user followers_count">\n        <label>Followers</label>\n        {{progileinfo.countFollowers}}\n      </h1>\n    </ion-col>\n    <ion-col col-6>\n      <h1 (click)="gotoPage(\'conn\')" class="follow_count_normal_user">\n        <label>Connection</label>\n        {{progileinfo.countFriends}}\n      </h1>\n    </ion-col>\n  </ion-row>\n\n\n\n  <ion-list>\n    <ion-item class="what_your_mind">\n      <ion-textarea [(ngModel)]="statustext" rows="3" placeholder="What’s on your mind ?"></ion-textarea>\n    </ion-item>\n  </ion-list>\n\n\n\n  <ion-row *ngIf="statusimage!=\'\' || statustags?.length > 0 || statusprivacytext!=\'\'" class="HomePost">\n\n    <ion-col *ngIf="statusprivacytext!=\'\'" col-12 text-center>\n      <div class="image_view ">\n        <div>\n          {{statusprivacytext}}\n        </div>\n      </div>\n    </ion-col>\n\n\n    <ion-col *ngIf="statusimage!=\'\'" col-12 text-center>\n      <div class="image_view ">\n        <div>\n          <img [src]="_DomSanitizer.bypassSecurityTrustUrl(statusimage)">\n        </div>\n        <button class="Image_delete" (click)="statusimage=\'\'">\n          <ion-icon name="remove-circle"></ion-icon>\n        </button>\n      </div>\n    </ion-col>\n\n    <ion-col *ngIf="statustags?.length > 0" col-12 text-center>\n      <ion-item *ngIf="statustags?.length > 0">\n        <p class="Post_tag statustags">\n          With\n          <span *ngFor="let tagitem of statustags;let idx = index">\n            <span>{{tagitem?.users_full_name}}\n              <span *ngIf="idx<(statustags?.length-1)">,</span>\n            </span>\n          </span>\n\n\n        </p>\n      </ion-item>\n    </ion-col>\n  </ion-row>\n  <ion-row class="HomePost">\n\n    <ion-col col-3>\n      <button (click)="addImage(\'Add Image To Status\',\'status\');">\n        <i class="material-icons add_a_photo-loop">add_a_photo</i>\n        Image\n      </button>\n    </ion-col>\n    <ion-col col-3>\n      <button (click)="showUsersTotag()">\n        <i class="material-icons">loyalty</i>\n        Tag\n      </button>\n    </ion-col>\n    <ion-col col-3>\n      <button (click)="statusPrivacy()">\n        <i class="material-icons">lock_outline</i>\n        Privacy\n      </button>\n    </ion-col>\n    <ion-col col-3>\n      <button (click)="postNewStatus()">\n        <i class="material-icons">near_me</i>\n        Post\n      </button>\n    </ion-col>\n\n  </ion-row>\n\n  <ion-row *ngFor="let item of homeData; let i=index">\n\n\n    <ion-col>\n      <div class="post_wrap">\n        <ion-list class="post_header">\n          <ion-item class="" padding-horizontal>\n            <ion-avatar class="person-pic" item-left>\n              <img *ngIf="item.image" src="{{base_url}}uploads/profileImages/thumbnailImages/{{item.image}}">\n              <img *ngIf="item.image==null || item.image==\'\'" src="assets/img/management.png">\n            </ion-avatar>\n\n            <ion-item class="status-check2">\n              <p class="Completed" text-center>\n                <span>{{item.users_full_name}}</span>\n                {{item.incident_name}}</p>\n              <span>{{item.creation_date | amDateFormat:\'MMMM Do YYYY, h:mm:ss a\'}}</span>\n            </ion-item>\n            <div class="post_action" *ngIf="item.incident_type===\'Status\' || item.incident_type===\'Profile\'">\n              <ion-icon (click)="presentActionSheet(item)" ios="ios-more" md="md-more"></ion-icon>\n            </div>\n          </ion-item>\n        </ion-list>\n\n        <ion-list class="post_body">\n          <ion-item *ngIf="item.incident_type===\'Status\'">\n            <p>{{item.user_status}}</p>\n            <img *ngIf="item.media_name!=\'\'" (click)="zoomStatusImage(item)" img-preloader="{{base_url}}uploads/statusMedia/{{item?.media_name}}?t={{milliseconds}}"\n            />\n          </ion-item>\n          <ion-item class="event_info" *ngIf="item.name" (click)="eventDetails(item)">\n            <span class="title" *ngIf="item.name">{{item.name | slice:0:20}}\n              <span *ngIf="item.name.length>20">...</span>\n            </span>from\n            <span *ngIf="item.start_date_time">{{item.start_date_time | amDateFormat:\'MMMM Do YYYY, h:mm a\'}} to</span>\n            <span *ngIf="item.end_date_time">{{item.end_date_time | amDateFormat:\'MMMM Do YYYY, h:mm a\'}} at</span>\n            <span *ngIf="item.location">{{item.location}}</span>\n          </ion-item>\n          <ion-item *ngIf="item.incident_type===\'Event\'" (click)="eventDetails(item)">\n            <p>{{item.user_status}}</p>\n            <img *ngIf="item.event_image!=\'\'" img-preloader="{{base_url}}uploads/eventsImages/{{item?.event_image}}" />\n            <img *ngIf="item.event_image==\'\' || item.event_image==null" src="assets/img/management.png" alt="avatar">\n            <div class="EventDetails">\n              {{item?.description | slice:0:113}}\n              <span *ngIf="item.description.length>110">.....</span>\n            </div>\n          </ion-item>\n          <a *ngIf="item.incident_type===\'Event\'" (click)="addtocalendarEvent(item)">Add to calender</a>\n\n          <ion-item *ngIf="item.incident_type===\'Profile\'">\n            <img img-preloader="{{base_url}}uploads/profileImages/{{item.incident_details}}" (click)="zoomProfileImage(item)" />\n\n\n          </ion-item>\n          <ion-item *ngIf="item.incident_type===\'Image\'">\n\n            <ion-row *ngIf="item.image_count>3">\n              <ion-col col-6 class="four_img" *ngFor="let albumimage of item.image_details; let i=index">\n                <img *ngIf="i<4" img-preloader="{{base_url}}uploads/portfolioImages/{{albumimage?.image_name}}" (click)="gotoPhotoView(albumimage)"\n                />\n                <i *ngIf="i==3 && item.image_count>4" class="last_img"> + {{item.image_count-4}} </i>\n              </ion-col>\n            </ion-row>\n\n            <ion-row *ngIf="item.image_count==2">\n              <ion-col col-6 class="four_img" *ngFor="let albumimage of item.image_details; let i=index">\n                <img img-preloader="{{base_url}}uploads/portfolioImages/{{albumimage?.image_name}}" (click)="gotoPhotoView(albumimage)" />\n\n              </ion-col>\n            </ion-row>\n\n\n            <ion-row *ngIf="item.image_count==3">\n              <ion-col col-6 class="four_img" [class.remove]="i==2" *ngFor="let albumimage of item.image_details; let i=index">\n                <img *ngIf="i<2" src="{{base_url}}uploads/portfolioImages/{{albumimage?.image_name}}" (click)="gotoPhotoView(albumimage)"\n                />\n              </ion-col>\n              <ion-col col-12 [class.remove]="i==0 || i==1" [class.threeimage]="i==2" [ngClass]="(albumimage?.image_name) ? \'img_loaded\' : \'img_loader\'"\n                *ngFor="let albumimage of item.image_details; let i=index">\n                <img *ngIf="i==2" img-preloader="{{base_url}}uploads/portfolioImages/{{albumimage?.image_name}}" (click)="gotoPhotoView(albumimage)"\n                />\n              </ion-col>\n            </ion-row>\n\n            <ion-row *ngIf="item.image_count==1">\n              <ion-col class="singel_img" col-12 *ngFor="let albumimage of item.image_details; let i=index" (click)="gotoPhotoView(albumimage)">\n                <img img-preloader="{{base_url}}uploads/portfolioImages/{{albumimage?.image_name}}" />\n              </ion-col>\n            </ion-row>\n\n          </ion-item>\n          <ion-item *ngIf="item.incident_type===\'Audio\';">\n\n            <audio-track #audio *ngFor="let track of item.myTracks" [track]="track" (click)=playThisTrack($event,track)>\n              <ion-item>\n                <ion-thumbnail item-left class="audio_action">\n                  <img img-preloader="assets/img/audio_new.png">\n                  <ion-icon name="play" *ngIf="track.select"></ion-icon>\n                  <ion-icon name="pause" *ngIf="!track.select"></ion-icon>\n                </ion-thumbnail>\n                <div item-content style="width:100%">\n                  <p>\n                    <strong (click)="audiodetails(item)">{{audio.title | slice:0:15}}\n                      <span *ngIf="audio?.title?.length>15">.....</span>\n                    </strong>\n                  </p>\n                  <audio-track-progress-bar dark duration progress [audioTrack]="audio" [ngStyle]="{visibility: audio.completed > 0 ? \'visible\' : \'show\'}"></audio-track-progress-bar>\n                </div>\n              </ion-item>\n            </audio-track>\n          </ion-item>\n\n          <ion-item *ngIf="item.incident_type===\'You Tube\'">\n\n            <iframe width="100%" [src]="_DomSanitizer.bypassSecurityTrustResourceUrl(item?.video_name)" frameborder="0 " donotallowfullscreen></iframe>\n\n\n          </ion-item>\n\n          <ion-item *ngIf="item.incident_type===\'Video\'">\n            <p text-center (click)="videodetails(item)">{{item.video_title | slice:0:20}}\n              <span *ngIf="item?.video_title?.length>20">.....</span>\n            </p>\n\n            <div (tap)="playvideo(item.video_name)">\n              <img src="{{base_url}}uploads/portfolioVideoSnapshots/{{item.snapshot_name}}" />\n            </div>\n            <img (tap)="playvideo(item.video_name)" class="play_img" src="assets/img/play.svg" width="50px">\n            <!-- <video #videoPlayer (click)="playvideo(item.video_name)" controls="controls" poster="{{base_url}}uploads/portfolioVideoSnapshots/{{item?.snapshot_name}}"\n              preload="metadata" webkit-playsinline="webkit-playsinline" class="videoPlayer">\n              <source src="{{base_url}}uploads/portfolioVideos/{{item?.video_name}}" type="video/mp4" />\n            </video> -->\n\n          </ion-item>\n          <ion-item *ngIf="item.tagged_to?.length > 0">\n            <p class="Post_tag">\n              With\n              <span *ngFor="let tagitem of item.tagged_to;let idx = index">\n                <span *ngIf="idx<2">{{tagitem?.name}}\n                  <span *ngIf="idx<(item.tagged_to?.length-1)">,</span>\n                </span>\n              </span>\n              <span (click)="showextrataggedusers(item)" *ngIf="item.tagged_to?.length > 2">\n                <span class="andText"> and </span>\n                <span>{{item.tagged_to?.length-2}} other</span>\n              </span>\n\n            </p>\n          </ion-item>\n\n\n        </ion-list>\n\n        <ion-row class="post_activity">\n          <ion-col col-4 [class.active]="item.likeCheck!=\'\'">\n            <ion-icon (click)="likeThisitem(item)" ios="ios-heart" md="md-heart"></ion-icon>\n            <span (click)="getWholiked(item);">{{item.likes}}</span>\n          </ion-col>\n          <ion-col (click)="showComments(item)" col-4>\n            <ion-icon ios="ios-text" md="md-text"></ion-icon>\n            <span>{{item.comments}}</span>\n          </ion-col>\n          <ion-col (click)="shareThisPost(item);" col-4 *ngIf="item.privacy==1">\n            <ion-icon ios="ios-share" md="md-share"></ion-icon>\n          </ion-col>\n        </ion-row>\n      </div>\n    </ion-col>\n  </ion-row>\n\n  <ion-infinite-scroll (ionInfinite)="fetchHomeData($event)">\n    <ion-infinite-scroll-content loadingSpinner="bubbles">\n    </ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n\n\n\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\home\home.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_24__ionic_native_streaming_media__["a" /* StreamingMedia */], __WEBPACK_IMPORTED_MODULE_20__ionic_native_photo_viewer__["a" /* PhotoViewer */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* App */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* ViewController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */],
        __WEBPACK_IMPORTED_MODULE_2_ionic_audio__["a" /* AudioProvider */], __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ModalController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */],
...
var CategoriesPage = (function () {
    function CategoriesPage(navCtrl, remotService, viewCtrl, alertCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.remotService = remotService;
        this.viewCtrl = viewCtrl;
        this.alertCtrl = alertCtrl;
    ...
    CategoriesPage.prototype.setFilteredItems = function () {
        ...
        this.remotService.getCategories(this.searchTerm, this.usertype).subscribe(function (response) {
    ...
    CategoriesPage.prototype.showAlert = function () {
        var _this = this;
        var alert = this.alertCtrl.create({
...
CategoriesPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* ViewController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], CategoriesPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__comment_comment__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_social_sharing__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_photodetails_photodetails__ = __webpack_require__(142);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PhotoviewPage = (function () {
    ...
    PhotoviewPage.prototype.initPhotoFromalbumData = function () {
        ...
        this.remotService.postData(DataToSend, 'portfolioImages').subscribe(function (response) {
            ...
            if (response.success == 1) {
                _this.albumphotos = response.data.Images;
                var oldarr = _this.albumphotos;
                var finalarr = [];
                for (var _i = 0, _a = _this.albumphotos; _i < _a.length; _i++) {
                    var i = _a[_i];
                    if (i.id == _this.img_id) {
                        finalarr.push(i);
                    }
                }
                for (var _b = 0, _c = _this.albumphotos; _b < _c.length; _b++) {
                    var i = _c[_b];
                    if (i.id != _this.img_id) {
                        finalarr.push(i);
                    }
                }
                _this.albumphotos = finalarr;
                _this.albumdetails = response.data.details;
                if (_this.albumphotos.length == 1) {
    ...
    * show comments
    */
    PhotoviewPage.prototype.showComments = function (currentimage) {
        var arr = [this.currentimage.id];
        var item = {
        ...
        var actionSheet = this.actionSheetCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    role: 'destructive',
                    handler: function () {
                        _this.addkeyword(_this.currentimage);
                    }
                },
                {
                    text: 'Delete',
    ...
    PhotoviewPage.prototype.addkeyword = function (currentimage) {
        var _this = this;
        var prompt = this.alertCtrl.create({
            title: 'Enter Keyword',
    ...
    PhotoviewPage.prototype.viewdetails = function (img) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_5__pages_photodetails_photodetails__["a" /* PhotodetailsPage */], { details: img });
    };
    PhotoviewPage.prototype.ionViewWillLeave = function () {
        this.remotService.dismissLoader();
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Navbar */])
], PhotoviewPage.prototype, "navBar", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* Slides */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* Slides */])
...
PhotoviewPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-photoview',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\photoview\photoview.html"*/'<ion-header class="creoyou-header">\n\n    <ion-navbar>\n        <ion-title>Photo Views</ion-title>\n\n        <ion-buttons end>\n            <button *ngIf="touserid == currentuserid" (tap)="editImg()" class="edit" ion-button clear>\n                <ion-icon name="settings"></ion-icon>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n\n\n\n</ion-header>\n\n\n<ion-content>\n\n\n\n    <ion-slides (ionSlideDidChange)="slideChanged()" class="Image_view">\n\n        <ion-slide *ngFor="let phto of albumphotos">\n            <img img-preloader="{{base_url}}uploads/portfolioImages/{{phto?.image_name}}" alt="Post Img" />\n            <p class="ImgTitle" *ngIf="phto.image_title">\n                <b>Title : {{phto.image_title | slice:0:20}}</b>\n                <span *ngIf="phto.image_title.length>20" (click)="viewdetails(phto)">...More</span>\n            </p>\n            <p class="ImgDes" *ngIf="phto.image_description">\n                <b>Description : </b>{{phto.image_description | slice:0:20}}\n                <span *ngIf="phto?.image_description?.length>20" (click)="viewdetails(phto)">...More</span>\n            </p>\n\n            <p class="ImgDes" *ngIf="phto.image_keywords">\n                <b>Keyword : </b>{{phto.image_keywords | slice:0:20}}\n                <span *ngIf="phto?.image_keywords?.length>20" (click)="viewdetails(phto)">...More</span>\n            </p>\n\n        </ion-slide>\n\n\n    </ion-slides>\n\n\n</ion-content>\n\n<ion-footer>\n    <ion-row class="post_activity">\n        <ion-col (click)="likeThisimage(currentimage);" col-4 [class.active]="currentimage?.likeActive>0">\n            <ion-icon ios="ios-heart" md="md-heart"></ion-icon>\n            <span>{{currentimage?.image_like}}</span>\n        </ion-col>\n        <ion-col col-4 (click)="showComments(currentimage)">\n            <ion-icon ios="ios-text" md="md-text"></ion-icon>\n            <span>{{currentimage?.count}}</span>\n        </ion-col>\n        <ion-col (click)="shareThisPost(currentimage);" col-4 *ngIf="albumdetails?.privacy==1">\n            <ion-icon ios="ios-share" md="md-share"></ion-icon>\n            <span>{{currentimage?.image_viewed}}</span>\n        </ion-col>\n    </ion-row>\n</ion-footer>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\photoview\photoview.html"*/,
    }),
...
var TaguserPage = (function () {
    function TaguserPage(navParams, navCtrl, remotService, viewCtrl) {
        this.navParams = navParams;
        this.navCtrl = navCtrl;
        this.remotService = remotService;
        this.viewCtrl = viewCtrl;
    ...
    TaguserPage.prototype.selectThisUser = function (e, item, index) {
        this.selectedTags = [];
        this.selectedTags[index] = item;
...
TaguserPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-taguser',template:/*ion-inline-start:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\taguser\taguser.html"*/'<ion-header class="creoyou-header">\n\n    <ion-navbar>\n        <ion-title>{{pagename}}</ion-title>\n        <ion-buttons end>\n            <button class="dismiss" (click)="dismiss()">\n                Done\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n\n    <ion-toolbar class="chatSearch">\n        <ion-searchbar [(ngModel)]="searchTerm" (ionInput)="setFilteredItems()"></ion-searchbar>\n    </ion-toolbar>\n    <div *ngIf="searching" class="spinner-container">\n        <ion-spinner></ion-spinner>\n    </div>\n</ion-header>\n\n\n<ion-content class="content-background">\n\n    <ion-grid>\n        <ion-row class="tag_item" *ngFor="let item of users;let idx = index">\n\n\n            <ion-col col-4 *ngIf="pagename==\'Invite your connections\'">\n                <ion-checkbox start (ionChange)="tagThisUser($event,item,idx)"></ion-checkbox>\n                <img *ngIf="item.image!=null && item.image!=\'\'" src="{{base_url}}uploads/profileImages/resizedImages/{{item.image}}" alt="avatar">\n                <img *ngIf="item.image==null || item.image==\'\'" src="assets/img/management.png" alt="avatar">\n            </ion-col>\n\n            <ion-col col-4 *ngIf="pagename==\'Tag Your Friend\'">\n                <ion-checkbox start (ionChange)="tagThisUser($event,item,idx)"></ion-checkbox>\n                <img *ngIf="item.image!=null && item.image!=\'\'" src="{{base_url}}uploads/profileImages/resizedImages/{{item.image}}" alt="avatar">\n                <img *ngIf="item.image==null || item.image==\'\'" src="assets/img/management.png" alt="avatar">\n            </ion-col>\n\n\n\n            <ion-col col-4 *ngIf="pagename==\'Search your connections\'">\n\n                <ion-radio radio-group [(ngModel)]="select" (ionSelect)="selectThisUser($event,item,idx)"></ion-radio>\n                <img *ngIf="item.image!=null && item.image!=\'\'" src="{{base_url}}uploads/profileImages/resizedImages/{{item.image}}" alt="avatar">\n                <img *ngIf="item.image==null || item.image==\'\'" src="assets/img/management.png" alt="avatar">\n            </ion-col>\n\n            <ion-col col-8>\n                <p>{{item.users_full_name}}</p>\n                <span>{{item.creativeField}}</span>\n            </ion-col>\n\n        </ion-row>\n    </ion-grid>\n\n</ion-content>'/*ion-inline-end:"D:\Masud Parvej\WGT Project\Creoyougit\src\pages\taguser\taguser.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__providers_remote_service_remote_service__["a" /* RemoteServiceProvider */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__messages_messages__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_otherprofile_otherprofile__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var MessagedetailsPage = (function () {
            ...
            if (response.success == 1) {
                if (response.data != null) {
                    response.data.forEach(function (item, key, index) {
                        ...
                        _this.blockeduser = item.user_status;
    ...
    MessagedetailsPage.prototype.OtherFrofileView = function (event) {
        /*  var data = {
           user_id: item.userId
         } */
        var _this = this;
        this.grabid.forEach(function (i) {
            //console.log(i);
            // console.log(i.nativeElement.childNodes[1].classList[1]);
            var data = {
                user_id: i.nativeElement.childNodes[1].classList[1]
            };
            _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__pages_otherprofile_otherprofile__["a" /* OtherprofilePage */], { 'otheruserfrofiledata': data });
        });
        //console.log(data);
        //  
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_remote_service_remote_service__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_messagedetails_messagedetails__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_newmessage_newmessage__ = __webpack_require__(261);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MessagesPage = (function () {
            ...
            if (response.success == 1) {
                ...
                if (response.data != null) {
                    response.data.userMessages.forEach(function (item, key, index) {
                        var g = item.content.toLowerCase();
                        var sub = 'shared profile :';
                        if (g.includes(sub)) {
                            var otherpart = g.replace(sub, '');
                            var obj = {
                                'image': item.image,
    ...
    MessagesPage.prototype.getItems = function (ev) {
        var val = ev.target.value;
        if (val && val.trim() != '') {
            this.usermessage = this.usermessage.filter(function (usermsg) {
                if (usermsg.fname) {
    ...
    MessagesPage.prototype.otherProfile = function () {
        // console.log('hiiiii');
    };
    return MessagesPage;
}());
